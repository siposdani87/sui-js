...
*/
'use strict';var e,aa='function'==typeof Object.defineProperties?Object.defineProperty:function(a,b,c){a!=Array.prototype&&a!=Object.prototype&&(a[b]=c.value)},f='undefined'!=typeof window&&window===this?this:'undefined'!=typeof global&&null!=global?global:this;function k(){k=function(){};f.Symbol||(f.Symbol=ba)}var ba=function(){var a=0;return function(b){return'jscomp_symbol_'+(b||'')+a++}}();
function l(){k();var a=f.Symbol.iterator;a||(a=f.Symbol.iterator=f.Symbol('iterator'));'function'!=typeof Array.prototype[a]&&aa(Array.prototype,a,{configurable:!0,writable:!0,value:function(){return m(this)}});l=function(){}}function m(a){var b=0;return ca(function(){return b<a.length?{done:!1,value:a[b++]}:{done:!0}})}function ca(a){l();a={next:a};a[f.Symbol.iterator]=function(){return this};return a}
function n(a){if(!(a instanceof Array)){l();k();l();var b=a[Symbol.iterator];a=b?b.call(a):m(a);for(var c=[];!(b=a.next()).done;)c.push(b.value);a=c}return a}function p(a,b){a=a.split('.');for(var c=window,d=a.pop(),h=0;h<a.length;h++)c=c[a[h]]=c[a[h]]||{};c[d]=b}var q=null;
...
function H(a,b){return a instanceof b}p('SUI.instanceOf',H);function B(a,b,c,d){G(a)?L(a,b,c,d):z(a)&&M(a,b)}p('SUI.each',B);function L(a,b,c,d){d=d||a.length;for(c=c||0;c<d;c++)b(a[c],c)}p('SUI.eachArray',L);function M(a,b){for(var c in a)a.hasOwnProperty(c)&&b(a[c],c)}p('SUI.eachObject',M);p('SUI.sleepEach',function(a,b,c,d){function h(){a(b);b++;b<c&&setTimeout(h,d)}h()});function N(a){G(a)?O(a):z(a)&&P(a)}p('SUI.clear',N);function O(a){a.splice(0,a.length)}p('SUI.clearArray',O);
function P(a){for(var b in a)a.hasOwnProperty(b)&&delete a[b]}p('SUI.clearObject',P);function K(a,b){return-1!==a.indexOf(b)}p('SUI.inArray',K);function v(a,b){return-1!==a.indexOf(b)}p('SUI.contain',v);function Q(a,b){var c=JSON.stringify(a),d=JSON.stringify(b);if(z(a)&&z(b)&&c.length===d.length){var h=!0;M(a,function(a,c){Q(b[c],a)||(h=!1)});return h}return c===d}p('SUI.isSame',Q);p('SUI.remove',function(a,b){b=a.indexOf(b);-1!==b&&a.splice(b,1)});
...
function T(a,b,c,d){c=void 0===c?500:c;d=void 0===d?20:d;clearInterval(q);var h=-(window.scrollX-a)/(c/d),g=-(window.scrollY-b)/(c/d);q=setInterval(function(){if(window.scrollX!==a||window.scrollY!==b){if(0<h&&window.scrollX+h>a||0>h&&window.scrollX+h<a)h=a-window.scrollX;if(0<g&&window.scrollY+g>b||0>g&&window.scrollY+g<b)g=b-window.scrollY;window.scrollBy(h,g)}else clearInterval(q)},d)}p('SUI.scrollTo',T);
p('SUI.scrollToElement',function(a,b,c){b=void 0===b?500:b;c=void 0===c?20:c;a=(new U(a)).getItem().node.offsetTop;T(0,a,b,c)});p('SUI.debounce',function(a,b,c){b=void 0===b?250:b;c=void 0===c?!1:c;var d;return function(h){for(var g=[],t=0;t<arguments.length;++t)g[t]=arguments[t];t=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(null,n(g))},b);t&&a.apply(null,n(g))}});p('SUI.urlWithQueryString',function(a,b){b=da(b);var c=v(a,'?')?'&':'?';return a+(b?c+b:'')});
function da(a){var b=[];B(a,function(a,d){G(a)?L(a,function(a){b.push(A('{0}[]={1}',[d,a]))}):E(a)||b.push(A('{0}={1}',[d,a]))});return R(b)?'':b.join('&')}p('SUI.getQueryString',da);p('SUI.getExtensionName',function(a){a=a.split('?',2)[0];return a.slice((Math.max(0,a.lastIndexOf('.'))||Infinity)+1)});function V(a){return[parseInt(a.substr(1,2),16),parseInt(a.substr(3,2),16),parseInt(a.substr(5,2),16)]}p('SUI.hexColorToRGB',V);
function ea(a,b,c){a=[a,b,c];for(b=0;b<a.length;b++)a[b]=16>=a[b]?'0'+a[b].toString(16):''+a[b].toString(16);return'#'+a.join('')}p('SUI.RGBtoHexColor',ea);p('SUI.colorContrastYIQ',function(a,b,c){a=V(a);return 128<=(299*a[0]+587*a[1]+114*a[2])/1E3?void 0===c?'#252525':c:void 0===b?'#FEFEFE':b});p('SUI.colorContrast',function(a,b){b=void 0===b?.5:b;a=V(a);for(var c=0;c<a.length;c++)a[c]+=Math.round(a[c]*b),0>a[c]?a[c]=0:255<a[c]&&(a[c]=255);return ea.apply(null,a)});function W(a){a=a||{};this.j(a)}W.prototype=Object.create(Object.prototype);e=W.prototype;e.constructor=W;e.j=function(a){if(z(a))for(var b in a)a.hasOwnProperty(b)&&(null===a[b]||!z(a[b])||G(a[b])?G(a[b])&&null!==a[b][0]&&z(a[b][0])?(fa(a,b),this[b]=a[b]):this[b]=r(a[b]):(H(this[b],W)||(this[b]=new W(this[b])),this[b].j(a[b])))};function fa(a,b){B(a[b],function(c,d){a[b][d]=new W(c)})}e.get=function(a,b,c){var d=this;a&&(a=(void 0===c?0:c)?[a]:a.split('.'),d=ha(this,this,a));return E(d)?b:d};
function ha(a,b,c){var d=void 0;M(b,function(a,g){1===c.length&&g===c[0]?d=b[g]:g===c[0]&&null!==b[g]&&z(b[g])&&(a=y(c),a.shift(),d=ha(this,b[g],a))}.bind(a));return d}e.set=function(a,b){var c={};a=a.split('.');for(var d=a.pop(),h=c,g=0;g<a.length;g++)h=h[a[g]]=h[a[g]]||{};h[d]=b;this.j(c)};e.remove=function(a){a=a.split('.');ia(this,this,a)};e.clear=function(){N(this)};
function ia(a,b,c){for(var d in b)if(b.hasOwnProperty(d))if(1===c.length&&d===c[0])delete b[d];else if(d===c[0]&&null!==b[d]&&z(b[d])){var h=y(c);h.shift();ia(a,b[d],h)}}e.copy=function(a){var b=y(this);a||(b=new W(b));return b};e.isEmpty=function(){return R(this)};function X(a,b,c){a=void 0===a?[]:a;b=void 0===b?W:b;c=void 0===c?{}:c;this.l=b;b=c;b=void 0===b?{}:b;this.options=new W({id:'id',parent:void 0});this.options.j(b);this.c=[];this.load(a)}e=X.prototype;e.load=function(a){var b=this;B(a,function(a){b.push(a)})};e.push=function(a){var b=a;H(a,this.l)||(b=new this.l(a,E(this.options.parent)?this:this.options.parent));a=b;this.c.push(a);return a};e.set=function(a,b){var c=b;H(b,this.l)||(c=new this.l(b,this));a<this.size()?this.c[a]=c:this.push(c);return c};
e.replace=function(a){var b=a.get(this.options.id);(b=ja(this,this.options.id,b))&&b.j(a);return b};e.iterator=function(a,b,c){c=c||this.c;var d=[];B(c,function(c,g){a(c)&&(b(c,g),d.push(c))});return d};e.get=function(a,b){var c=null;0<=a&&a<this.c.length&&(c=a=this.c[a],b&&(c=a.get(b)));return c};e.clear=function(){N(this.c)};function ja(a,b,c){return ka(a,function(d,h){return a.get(h,b)===c})}function ka(a,b){for(var c=0;c<a.c.length&&!b(a.c[c],c);)c++;return a.get(c)}
e.delete=function(a){return la(this,function(b){return b===a})};function la(a,b){for(var c=0;c<a.c.length&&!b(a.c[c],c);)c++;b=a.get(c);a.c.splice(c,1);return b}e.size=function(){return this.c.length};function U(a,b){this.f=b||document;I(this.f.m)&&(this.f=this.f.node);b=[];-1!==a.indexOf(' ')||1<a.split('.').length-1||-1<a.indexOf('.')&&0!==a.indexOf('.')||-1!==a.indexOf('[')?b=this.f.querySelectorAll(a):0===a.indexOf('#')?(I(this.f.getElementById)||(this.f=document),a=this.f.getElementById(a.replace('#','')),b.push(a)):b=0===a.indexOf('.')?this.f.getElementsByClassName(a.replace('.','')):this.f.getElementsByTagName(a);a=[];for(var c=0;c<b.length;c++)b[c]&&a.push(b[c]);X.call(this,a,Y,{parent:null})}
var Z=U;Z.prototype=Object.create(X.prototype);Z.prototype.constructor=Z;U.prototype.getItem=function(){var a=this.get(0);a||(a=new Y(null));return a};function Y(a,b){if(u(a))if(v(a,'<')&&v(a,'</')){var c=document.createElement('template');c.innerHTML=a;a=c.content.firstElementChild}else a=document.createElement(a);this.node=a;this.c=b}e=Y.prototype;e.set=function(a,b){'id'===a?this.node.id=b:this.setAttribute(a,b)};e.j=function(a){var b=this;B(a,function(a,d){b.set(d,a)})};e.get=function(a){return'id'===a?this.node.id||null:this.node.getAttribute(a)||null};e.m=function(){return this.node};
