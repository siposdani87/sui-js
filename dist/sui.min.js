...
e.setAttribute=function(a,b){b=A(b)?a:b;E(b)?this.node[a]=b:q(a,'data-')&&v(b)?this.node.setAttribute(a,JSON.stringify(b)):this.node.setAttribute(a,b)};e.getAttribute=function(a){var b=this.node.getAttribute(a);return q(a,'data-')&&b&&('['===b[0]||'{'===b[0])?JSON.parse(b)||null:n(b||null)};e.removeAttribute=function(a){this.node.removeAttribute(a)};e.addEventListener=function(a,b){var c=this,d=B();b&&(d=function(f){b(c,f);f.stopPropagation()},this.node.addEventListener(a,d),ca(this,a,d));return d};
function ca(a,b,c){a.node._listeners||(a.node._listeners={});a.node._listeners[b]||(a.node._listeners[b]=[]);a.node._listeners[b].push(c)}e.trigger=function(a){a=new Event(a);this.node.dispatchEvent(a)};e.createElement=function(a){a=document.createElement(a);return new X(a,this)};e.appendChild=function(a){this.node.appendChild(a.node)};e.removeChild=function(a){if(this.node.hasChildNodes())try{this.node.removeChild(a.node)}catch(b){console.warn(b)}};
e.remove=function(){var a=this.c&&!this.c.isEmpty()?this.c.node:this.node?this.node.parentElement:null;!this.isEmpty()&&a&&a.removeChild(this.node)};e.getComputedStyle=function(){return window.getComputedStyle(this.node)};e.setStyle=function(a){var b=this;x(a,function(c,d){b.node.style.setProperty(d,c,'')})};e.isEmpty=function(){return!this.node};e.toString=function(a){return void 0===a||a?this.node.outerHTML:this.node.innerHTML};function W(a){a=a||{};this.j(a)}k('SUI.Object',W);W.prototype=Object.create(Object.prototype);W.prototype.constructor=W;W.prototype.j=function(a){if(v(a))for(var b in a)a.hasOwnProperty(b)&&(null===a[b]||!v(a[b])||C(a[b])?C(a[b])&&null!==a[b][0]&&v(a[b][0])?(da(a,b),this[b]=a[b]):this[b]=n(a[b]):(D(this[b],W)||(this[b]=new W(this[b])),this[b].j(a[b])));return this};W.prototype.merge=W.prototype.j;function da(a,b){x(a[b],function(c,d){a[b][d]=new W(c)})}
W.prototype.get=function(a,b,c){var d=this;a&&(d=ea(this,this,(void 0===c?0:c)?[a]:a.split('.')));return A(d)?b:d};W.prototype.get=W.prototype.get;function ea(a,b,c){var d=void 0;I(b,function(f,g){1===c.length&&g===c[0]?d=b[g]:g===c[0]&&null!==b[g]&&v(b[g])&&(f=u(c),f.shift(),d=ea(this,b[g],f))}.bind(a));return d}function fa(a,b,c,d){I(b,function(f,g){1===c.length&&g===c[0]?b[g]=d:g===c[0]&&null!==b[g]&&v(b[g])&&(f=u(c),f.shift(),fa(this,b[g],f,d))}.bind(a))}
W.prototype.set=function(a,b){var c={};a=a.split('.');for(var d=a.pop(),f=c,g=0;g<a.length;g++)f=f[a[g]]=f[a[g]]||{};f[d]=b;this.j(c)};W.prototype.set=W.prototype.set;W.prototype.v=function(a,b,c){c=void 0===c?!1:c;this.set(a,null);fa(this,this,c?[a]:a.split('.'),b)};W.prototype.setRaw=W.prototype.v;W.prototype.remove=function(a){ha(this,this,a.split('.'))};W.prototype.remove=W.prototype.remove;W.prototype.clear=function(){J(this)};W.prototype.clear=W.prototype.clear;
function ha(a,b,c){for(var d in b)if(b.hasOwnProperty(d))if(1===c.length&&d===c[0])delete b[d];else if(d===c[0]&&null!==b[d]&&v(b[d])){var f=u(c);f.shift();ha(a,b[d],f)}}W.prototype.l=function(a,b,c){var d=this,f=c||[];I(b||this,function(g,m){var M=u(f);M.push(m);null!==g&&v(g)?d.l(a,g,M):a(g,M.join('.'))})};W.prototype.each=W.prototype.l;W.prototype.copy=function(a){a=void 0===a?!1:a;var b=u(this);a||(b=new W(b));return b};W.prototype.copy=W.prototype.copy;W.prototype.isEmpty=function(){return P(this)};
W.prototype.isEmpty=W.prototype.isEmpty;function Y(a,b,c){a=void 0===a?[]:a;b=void 0===b?W:b;c=void 0===c?{}:c;this.m=b;b=c;b=void 0===b?{}:b;this.options=new W({id:'id',parent:void 0});this.options.j(b);this.c=[];this.load(a)}e=Y.prototype;e.load=function(a){var b=this;x(a,function(c){b.push(c)})};e.push=function(a){var b=a;D(a,this.m)||(b=new this.m(a,A(this.options.parent)?this:this.options.parent));a=b;this.c.push(a);return a};e.set=function(a,b){var c=b;D(b,this.m)||(c=new this.m(b,this));a<this.size()?this.c[a]=c:this.push(c);return c};
e.replace=function(a){var b=a.get(this.options.id);(b=ia(this,this.options.id,b))&&b.j(a);return b};function ja(a,b,c){var d=d||a.c;var f=[];x(d,function(g,m){b(g)&&(c(g,m),f.push(g))})}e.l=function(a){ja(this,function(){return!0},a)};e.get=function(a,b){var c=null;0<=a&&a<this.c.length&&(c=a=this.c[a],b&&(c=a.get(b)));return c};e.clear=function(){J(this.c)};function ia(a,b,c){return ka(a,function(d,f){return a.get(f,b)===c})}
function ka(a,b){for(var c=0;c<a.c.length&&!b(a.c[c],c);)c++;return a.get(c)}e.delete=function(a){return la(this,function(b){return b===a})};function la(a,b){for(var c=0;c<a.c.length&&!b(a.c[c],c);)c++;b=a.get(c);a.c.splice(c,1);return b}e.size=function(){return this.c.length};function S(a,b){this.f=b||document;E(this.f.o)&&(this.f=this.f.node);b=[];-1!==a.indexOf(' ')||1<a.split('.').length-1||-1<a.indexOf('.')&&0!==a.indexOf('.')||-1!==a.indexOf('[')?b=this.f.querySelectorAll(a):0===a.indexOf('#')?(E(this.f.getElementById)||(this.f=document),b.push(this.f.getElementById(a.replace('#','')))):0===a.indexOf('.')?b=this.f.getElementsByClassName(a.replace('.','')):b=this.f.getElementsByTagName(a);a=[];for(var c=0;c<b.length;c++)b[c]&&a.push(b[c]);Y.call(this,a,X,{parent:null})}
