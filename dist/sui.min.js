...
e.addEventListener=function(a,b){var c=this,d=B();b&&(d=function(f){b(c,f)||(f.stopPropagation(),f.preventDefault())},this.node.addEventListener(a,d),la(this,a,d));return d};function la(a,b,c){a.node._listeners||(a.node._listeners={});a.node._listeners[b]||(a.node._listeners[b]=[]);a.node._listeners[b].push(c)}e.trigger=function(a){a=new Event(a);this.node.dispatchEvent(a)};e.createElement=function(a){a=document.createElement(a);return new Y(a,this)};e.appendChild=function(a){this.node.appendChild(a.node)};
