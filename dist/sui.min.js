...
function r(a){var b=a;t(a)&&!v(a,' ')&&(a=a.toLowerCase(),''===a?b='':'undefined'===a?b=void 0:'null'===a?b=null:'true'===a?b=!0:'false'===a?b=!1:'infinity'===a?b=Infinity:w(a)&&(b=-1!==a.indexOf('.')?parseFloat(a):parseInt(a,0)));return b}p('SUI.typeCast',r);function x(a,b){a=y(a);for(var c in b)b.hasOwnProperty(c)&&(a[c]=z(b[c].constructor)?x(a[c],b[c]):b[c]);return a}p('SUI.merge',x);
function A(a,b,c,d){c=void 0===c?'\\{':c;d=void 0===d?'\\}':d;B(b,function(b,h){a=a.replace(new RegExp(c+h+d,'gm'),b)});return a}p('SUI.format',A);p('SUI.convert',function(a,b){var c=a;w(a)?c=C(a,b):t(a)&&(c=D(a,b));return c});function C(a,b){var c=a;switch(b){case 'string':c=a.toString()}return c}p('SUI.convertNumber',C);function D(a,b){var c=a;switch(b){case 'integer':c=parseInt(a,10);break;case 'float':c=parseFloat(a)}return c}p('SUI.convertString',D);
p('SUI.defaultValue',function(a,b){return E(a)?b:a});function F(a){return function(){return a}}p('SUI.noop',F);p('SUI.eq',function(a,b){return a===b});p('SUI.neq',function(a,b){return a!==b});p('SUI.gt',function(a,b){return a>b});p('SUI.gte',function(a,b){return a>=b});p('SUI.lt',function(a,b){return a<b});p('SUI.lte',function(a,b){return a<=b});function G(a){return H(a,Array)}p('SUI.isArray',G);function I(a){return J(a,'function')}p('SUI.isFunction',I);function t(a){return J(a,'string')}
p('SUI.isString',t);function w(a){return!isNaN(a)&&(!K(['0','+'],a[0])||'0'===a)}p('SUI.isNumber',w);p('SUI.isFloat',function(a){return parseFloat(a)===a});p('SUI.isInteger',function(a){return parseInt(a,0)===a});function z(a){return J(a,'object')}p('SUI.isObject',z);p('SUI.isNull',function(a){return null===a});function E(a){return J(a,'undefined')}p('SUI.isUndefined',E);p('SUI.isFinite',function(a){return isFinite(a)});function J(a,b){return typeof a===b}p('SUI.is',J);
...
p('SUI.capitalize',function(a){return a.charAt(0).toUpperCase()+a.slice(1)});p('SUI.pluck',function(a,b){var c=[];B(a,function(a){a=a.get(b);c.push(a)});return c});p('SUI.pluckKeys',function(a,b){var c=[];M(a,function(a,f){b(a)&&c.push(f)});return c});
p('SUI.currency',function(a,b,c,d){b=void 0===b?' ':b;c=void 0===c?',':c;d=void 0===d?0:d;a||(a=0);a=Math10.round(a,-1*d);d=a.toFixed(d).toString().split('.');a=d[1];d=d[0].split('').reverse().map(function(a,c){return c%3||!c?a:a+b}).reverse().join('');a&&(d+=c+a);return d});
...
p('SUI.scrollToElement',function(a,b,c){b=void 0===b?500:b;c=void 0===c?20:c;a=(new T(a)).getItem().node.offsetTop;da(0,a,b,c)});p('SUI.debounce',function(a,b,c){b=void 0===b?250:b;c=void 0===c?!1:c;var d;return function(f){for(var h=[],u=0;u<arguments.length;++u)h[u]=arguments[u];u=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(null,n(h))},b);u&&a.apply(null,n(h))}});p('SUI.urlWithQueryString',function(a,b){b=ea(b);var c=v(a,'?')?'&':'?';return a+(b?c+b:'')});
