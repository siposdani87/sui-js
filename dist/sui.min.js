...
k('SUI.allowKeys',function(a,b){return V(a,function(c){return N(b,c)})});k('SUI.denyKeys',function(a,b){return V(a,function(c){return!N(b,c)})});function V(a,b){a=new W(a);var c=new W;a.m(function(d,f){b(f)&&c.set(f,d)});return c}k('SUI.filterKeys',V);k('SUI.normalize',function(a){return a.normalize('NFD').replace(/[\u0300-\u036f]/g,'')});function W(a){a=a||{};this.j(a)}W.prototype=Object.create(Object.prototype);e=W.prototype;e.constructor=W;e.j=function(a){if(v(a))for(var b in a)a.hasOwnProperty(b)&&(null===a[b]||!v(a[b])||C(a[b])?C(a[b])&&null!==a[b][0]&&v(a[b][0])?(ca(a,b),this[b]=a[b]):this[b]=m(a[b]):(D(this[b],W)||(this[b]=new W(this[b])),this[b].j(a[b])))};function ca(a,b){x(a[b],function(c,d){a[b][d]=new W(c)})}e.get=function(a,b,c){var d=this;a&&(d=da(this,this,(void 0===c?0:c)?[a]:a.split('.')));return A(d)?b:d};
function da(a,b,c){var d=void 0;I(b,function(f,g){1===c.length&&g===c[0]?d=b[g]:g===c[0]&&null!==b[g]&&v(b[g])&&(f=u(c),f.shift(),d=da(this,b[g],f))}.bind(a));return d}e.set=function(a,b){var c={};a=a.split('.');for(var d=a.pop(),f=c,g=0;g<a.length;g++)f=f[a[g]]=f[a[g]]||{};f[d]=b;this.j(c)};e.remove=function(a){ea(this,this,a.split('.'))};e.clear=function(){J(this)};
function ea(a,b,c){for(var d in b)if(b.hasOwnProperty(d))if(1===c.length&&d===c[0])delete b[d];else if(d===c[0]&&null!==b[d]&&v(b[d])){var f=u(c);f.shift();ea(a,b[d],f)}}e.m=function(a,b,c){var d=this,f=c||[];I(b||this,function(g,n){var M=u(f);M.push(n);null!==g&&v(g)?d.m(a,g,M):a(g,M.join('.'))})};e.copy=function(a){a=void 0===a?!1:a;var b=u(this);a||(b=new W(b));return b};e.isEmpty=function(){return P(this)};function X(a,b,c){a=void 0===a?[]:a;b=void 0===b?W:b;c=void 0===c?{}:c;this.l=b;b=c;b=void 0===b?{}:b;this.options=new W({id:'id',parent:void 0});this.options.j(b);this.c=[];this.load(a)}e=X.prototype;e.load=function(a){var b=this;x(a,function(c){b.push(c)})};e.push=function(a){var b=a;D(a,this.l)||(b=new this.l(a,A(this.options.parent)?this:this.options.parent));a=b;this.c.push(a);return a};e.set=function(a,b){var c=b;D(b,this.l)||(c=new this.l(b,this));a<this.size()?this.c[a]=c:this.push(c);return c};
e.replace=function(a){var b=a.get(this.options.id);(b=fa(this,this.options.id,b))&&b.j(a);return b};e.iterator=function(a,b,c){c=c||this.c;var d=[];x(c,function(f,g){a(f)&&(b(f,g),d.push(f))});return d};e.m=function(a){this.iterator(function(){return!0},a)};e.get=function(a,b){var c=null;0<=a&&a<this.c.length&&(c=a=this.c[a],b&&(c=a.get(b)));return c};e.clear=function(){J(this.c)};function fa(a,b,c){return ha(a,function(d,f){return a.get(f,b)===c})}
function ha(a,b){for(var c=0;c<a.c.length&&!b(a.c[c],c);)c++;return a.get(c)}e.delete=function(a){return ia(this,function(b){return b===a})};function ia(a,b){for(var c=0;c<a.c.length&&!b(a.c[c],c);)c++;b=a.get(c);a.c.splice(c,1);return b}e.size=function(){return this.c.length};function S(a,b){this.f=b||document;E(this.f.o)&&(this.f=this.f.node);b=[];-1!==a.indexOf(' ')||1<a.split('.').length-1||-1<a.indexOf('.')&&0!==a.indexOf('.')||-1!==a.indexOf('[')?b=this.f.querySelectorAll(a):0===a.indexOf('#')?(E(this.f.getElementById)||(this.f=document),b.push(this.f.getElementById(a.replace('#','')))):b=0===a.indexOf('.')?this.f.getElementsByClassName(a.replace('.','')):this.f.getElementsByTagName(a);a=[];for(var c=0;c<b.length;c++)b[c]&&a.push(b[c]);X.call(this,a,Y,{parent:null})}
...
e.o=function(){return this.node};e.setAttribute=function(a,b){b=A(b)?a:b;E(b)?this.node[a]=b:q(a,'data-')&&v(b)?this.node.setAttribute(a,JSON.stringify(b)):this.node.setAttribute(a,b)};e.addEventListener=function(a,b){var c=this,d=B();b&&(d=function(f){b(c,f);f.stopPropagation()},this.node.addEventListener(a,d),ja(this,a,d));return d};function ja(a,b,c){a.node._listeners||(a.node._listeners={});a.node._listeners[b]||(a.node._listeners[b]=[]);a.node._listeners[b].push(c)}
e.trigger=function(a){a=new Event(a);this.node.dispatchEvent(a)};e.createElement=function(a){a=document.createElement(a);return new Y(a,this.c)};e.appendChild=function(a){this.node.appendChild(a.node)};e.removeChild=function(a){if(this.node.hasChildNodes())try{this.node.removeChild(a.node)}catch(b){console.warn(b)}};e.remove=function(){var a=this.c&&!this.c.isEmpty()?this.c.node:this.node?this.node.parentElement:null;!this.isEmpty()&&a&&a.removeChild(this.node)};e.getComputedStyle=function(){return window.getComputedStyle(this.node)};
e.setStyle=function(a){var b=this;x(a,function(c,d){b.node.style.setProperty(d,c,'')})};e.isEmpty=function(){return!this.node};e.toString=function(a){return void 0===a||a?this.node.outerHTML:this.node.innerHTML};
