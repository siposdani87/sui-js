...
function m(a){var b=a;p(a)&&!q(a,' ')&&(a=a.toLowerCase(),''===a?b='':'undefined'===a?b=void 0:'null'===a?b=null:'true'===a?b=!0:'false'===a?b=!1:'infinity'===a?b=Infinity:r(a)&&(b=-1!==a.indexOf('.')?parseFloat(a):parseInt(a,0)));return b}k('SUI.typeCast',m);function t(a,b){a=u(a);for(var c in b)b.hasOwnProperty(c)&&(a[c]=v(b[c].constructor)?t(a[c],b[c]):b[c]);return a}k('SUI.merge',t);
function w(a,b,c,d){c=void 0===c?'\\{':c;d=void 0===d?'\\}':d;x(b,function(f,g){a=a.replace(new RegExp(c+g+d,'gm'),f)});return a}k('SUI.format',w);k('SUI.convert',function(a,b){var c=a;r(a)?c=y(a,b):p(a)&&(c=z(a,b));return c});function y(a,b){var c=a;switch(b){case 'string':c=a.toString()}return c}k('SUI.convertNumber',y);function z(a,b){var c=a;switch(b){case 'integer':c=parseInt(a,10);break;case 'float':c=parseFloat(a)}return c}k('SUI.convertString',z);
...
function L(a){for(var b in a)a.hasOwnProperty(b)&&delete a[b]}k('SUI.clearObject',L);function G(a,b){return-1!==a.indexOf(b)}k('SUI.inArray',G);function q(a,b){return-1!==a.indexOf(b)}k('SUI.contain',q);function N(a,b){for(var c=0;c<a.length&&!q(b,a[c]);)c++;return c<a.length}k('SUI.inContainArray',N);function O(a,b){var c=JSON.stringify(a),d=JSON.stringify(b);if(v(a)&&v(b)&&c.length===d.length){var f=!0;I(a,function(g,n){O(b[n],g)||(f=!1)});return f}return c===d}k('SUI.isSame',O);
k('SUI.remove',function(a,b){b=a.indexOf(b);-1!==b&&a.splice(b,1)});function u(a){if(C(a))var b=[].concat(a);else v(a)&&(b={},x(a,function(c,d){b[d]=v(c)?u(c):c}));return b}k('SUI.copy',u);function P(a){var b=!1;if(C(a))b=0===a.length;else if(v(a)){var c=0;x(a,function(){c++});b=0===c}return b}k('SUI.isEmpty',P);k('SUI.list',function(a,b){b.apply(null,h(a))});k('SUI.random',function(a,b,c){return(void 0===c?0:c)?Math.random()*(b-a)+a:Math.floor(Math.random()*(b-a+1))+a});k('SUI.encodeBase64',function(a){return window.btoa(a)});
k('SUI.decodeBase64',function(a){return window.atob(a)});k('SUI.capitalize',function(a){return a.charAt(0).toUpperCase()+a.slice(1)});k('SUI.pluck',function(a,b){var c=[];x(a,function(d){d=d.get(b);c.push(d)});return c});k('SUI.pluckKeys',function(a,b){var c=[];I(a,function(d,f){b(d)&&c.push(f)});return c});
...
k('SUI.scrollToElement',function(a,b,c){b=void 0===b?500:b;c=void 0===c?20:c;a=(new S(a)).getItem().node;R(a.offsetLeft,a.offsetTop,b,c)});k('SUI.debounce',function(a,b,c){b=void 0===b?250:b;c=void 0===c?!1:c;var d;return function(f){for(var g=[],n=0;n<arguments.length;++n)g[n]=arguments[n];n=c&&!d;clearTimeout(d);d=setTimeout(function(){d=null;c||a.apply(null,h(g))},b);n&&a.apply(null,h(g))}});k('SUI.urlWithQueryString',function(a,b){b=T(b);var c=q(a,'?')?'&':'?';return a+(b?c+b:'')});
...
k('SUI.allowKeys',function(a,b){return V(a,function(c){return N(b,c)})});k('SUI.denyKeys',function(a,b){return V(a,function(c){return!N(b,c)})});function V(a,b){a=new W(a);var c=new W;a.m(function(d,f){b(f)&&c.set(f,d)});return c}k('SUI.filterKeys',V);k('SUI.normalize',function(a){return a.normalize('NFD').replace(/[\u0300-\u036f]/g,'')});function X(a,b){if(p(a))if(q(a,'<')&&q(a,'</')){var c=document.createElement('template');c.innerHTML=a;a=c.content.firstElementChild}else a=document.createElement(a);this.node=a;this.c=b}e=X.prototype;e.set=function(a,b){'id'===a?this.node.id=b:this.setAttribute(a,b)};e.j=function(a){var b=this;x(a,function(c,d){b.set(d,c)})};e.get=function(a){if('id'===a)a=this.node.id||null;else{var b=this.node.getAttribute(a);a=q(a,'data-')&&b&&('['===b[0]||'{'===b[0])?JSON.parse(b)||null:m(b||null)}return a};
e.o=function(){return this.node};e.setAttribute=function(a,b){b=A(b)?a:b;E(b)?this.node[a]=b:q(a,'data-')&&v(b)?this.node.setAttribute(a,JSON.stringify(b)):this.node.setAttribute(a,b)};e.addEventListener=function(a,b){var c=this,d=B();b&&(d=function(f){b(c,f);f.stopPropagation()},this.node.addEventListener(a,d),ca(this,a,d));return d};function ca(a,b,c){a.node._listeners||(a.node._listeners={});a.node._listeners[b]||(a.node._listeners[b]=[]);a.node._listeners[b].push(c)}
e.trigger=function(a){a=new Event(a);this.node.dispatchEvent(a)};e.createElement=function(a){a=document.createElement(a);return new X(a,this.c)};e.appendChild=function(a){this.node.appendChild(a.node)};e.removeChild=function(a){if(this.node.hasChildNodes())try{this.node.removeChild(a.node)}catch(b){console.warn(b)}};e.remove=function(){var a=this.c&&!this.c.isEmpty()?this.c.node:this.node?this.node.parentElement:null;!this.isEmpty()&&a&&a.removeChild(this.node)};e.getComputedStyle=function(){return window.getComputedStyle(this.node)};
e.setStyle=function(a){var b=this;x(a,function(c,d){b.node.style.setProperty(d,c,'')})};e.isEmpty=function(){return!this.node};e.toString=function(a){return void 0===a||a?this.node.outerHTML:this.node.innerHTML};function W(a){a=a||{};this.j(a)}W.prototype=Object.create(Object.prototype);e=W.prototype;e.constructor=W;e.j=function(a){if(v(a))for(var b in a)a.hasOwnProperty(b)&&(null===a[b]||!v(a[b])||C(a[b])?C(a[b])&&null!==a[b][0]&&v(a[b][0])?(da(a,b),this[b]=a[b]):this[b]=m(a[b]):(D(this[b],W)||(this[b]=new W(this[b])),this[b].j(a[b])))};function da(a,b){x(a[b],function(c,d){a[b][d]=new W(c)})}e.get=function(a,b,c){var d=this;a&&(d=ea(this,this,(void 0===c?0:c)?[a]:a.split('.')));return A(d)?b:d};
function ea(a,b,c){var d=void 0;I(b,function(f,g){1===c.length&&g===c[0]?d=b[g]:g===c[0]&&null!==b[g]&&v(b[g])&&(f=u(c),f.shift(),d=ea(this,b[g],f))}.bind(a));return d}e.set=function(a,b){var c={};a=a.split('.');for(var d=a.pop(),f=c,g=0;g<a.length;g++)f=f[a[g]]=f[a[g]]||{};f[d]=b;this.j(c)};e.remove=function(a){fa(this,this,a.split('.'))};e.clear=function(){J(this)};
function fa(a,b,c){for(var d in b)if(b.hasOwnProperty(d))if(1===c.length&&d===c[0])delete b[d];else if(d===c[0]&&null!==b[d]&&v(b[d])){var f=u(c);f.shift();fa(a,b[d],f)}}e.m=function(a,b,c){var d=this,f=c||[];I(b||this,function(g,n){var M=u(f);M.push(n);null!==g&&v(g)?d.m(a,g,M):a(g,M.join('.'))})};e.copy=function(a){a=void 0===a?!1:a;var b=u(this);a||(b=new W(b));return b};e.isEmpty=function(){return P(this)};function Y(a,b,c){a=void 0===a?[]:a;b=void 0===b?W:b;c=void 0===c?{}:c;this.l=b;b=c;b=void 0===b?{}:b;this.options=new W({id:'id',parent:void 0});this.options.j(b);this.c=[];this.load(a)}e=Y.prototype;e.load=function(a){var b=this;x(a,function(c){b.push(c)})};e.push=function(a){var b=a;D(a,this.l)||(b=new this.l(a,A(this.options.parent)?this:this.options.parent));a=b;this.c.push(a);return a};e.set=function(a,b){var c=b;D(b,this.l)||(c=new this.l(b,this));a<this.size()?this.c[a]=c:this.push(c);return c};
e.replace=function(a){var b=a.get(this.options.id);(b=ha(this,this.options.id,b))&&b.j(a);return b};e.iterator=function(a,b,c){c=c||this.c;var d=[];x(c,function(f,g){a(f)&&(b(f,g),d.push(f))});return d};e.m=function(a){this.iterator(function(){return!0},a)};e.get=function(a,b){var c=null;0<=a&&a<this.c.length&&(c=a=this.c[a],b&&(c=a.get(b)));return c};e.clear=function(){J(this.c)};function ha(a,b,c){return ia(a,function(d,f){return a.get(f,b)===c})}
function ia(a,b){for(var c=0;c<a.c.length&&!b(a.c[c],c);)c++;return a.get(c)}e.delete=function(a){return ja(this,function(b){return b===a})};function ja(a,b){for(var c=0;c<a.c.length&&!b(a.c[c],c);)c++;b=a.get(c);a.c.splice(c,1);return b}e.size=function(){return this.c.length};function S(a,b){this.f=b||document;E(this.f.o)&&(this.f=this.f.node);b=[];-1!==a.indexOf(' ')||1<a.split('.').length-1||-1<a.indexOf('.')&&0!==a.indexOf('.')||-1!==a.indexOf('[')?b=this.f.querySelectorAll(a):0===a.indexOf('#')?(E(this.f.getElementById)||(this.f=document),b.push(this.f.getElementById(a.replace('#','')))):b=0===a.indexOf('.')?this.f.getElementsByClassName(a.replace('.','')):this.f.getElementsByTagName(a);a=[];for(var c=0;c<b.length;c++)b[c]&&a.push(b[c]);Y.call(this,a,X,{parent:null})}
var Z=S;Z.prototype=Object.create(Y.prototype);Z.prototype.constructor=Z;S.prototype.getItem=function(){var a=this.get(0);a||(a=new X(null));return a};
