...
*/
var SUI={title:'SUI-JS',description:'A frontend framework, help you to build fast, modern applications',version:'0.4.10',const:{},config:{},res:{},lib:{},test:{},widget:{},_scrollInterval:null,coreRes:{app:'app',config:'config',event:'event',scheduler:'scheduler',http:'http',notification:'notification',template:'template',dialog:'dialog',confirm:'confirm',viewer:'viewer',header:'header',topMenu:'topMenu',leftMenu:'leftMenu',leftSidebar:'leftSidebar',rightSidebar:'rightSidebar',footer:'footer',bottomMenu:'bottomMenu',
navBar:'navBar',script:'script',style:'style',state:'state',dom:'dom',document:'document',window:'window',helper:'helper',cookie:'cookie',localStorage:'localStorage',sessionStorage:'sessionStorage',browser:'browser',loader:'loader',progressBar:'progressBar',geoLocation:'geoLocation',instances:'instances',console:'console',appCache:'appCache',serviceWorker:'serviceWorker',actionCable:'actionCable'},production:!1,typeCast:function(a){var b=a;SUI.isString(a)&&!SUI.contain(a,' ')&&(a=a.toLowerCase(),
SUI.eq(a,'')?b='':SUI.eq(a,'undefined')?b=void 0:SUI.eq(a,'null')?b=null:SUI.eq(a,'true')?b=!0:SUI.eq(a,'false')?b=!1:SUI.eq(a,'infinity')?b=Infinity:SUI.isNumber(a)&&(b=SUI.neq(a.indexOf('.'),-1)?parseFloat(a):parseInt(a,0)));return b}};goog.exportSymbol('SUI.typeCast',SUI.typeCast);
SUI.invoke=function(a,b,c,d){SUI.Cls=function(){c&&c.apply(this,d||b);return a.apply(this,b)};c?(SUI.Cls.prototype=SUI.merge(c.prototype,a.prototype),SUI.Cls.prototype.constructor=SUI.Cls):SUI.Cls.prototype=a.prototype;return new SUI.Cls};SUI.merge=function(a,b){a=SUI.copy(a);for(var c in b)b.hasOwnProperty(c)&&(SUI.isObject(b[c].constructor)?a[c]=SUI.merge(a[c],b[c]):a[c]=b[c]);return a};goog.exportSymbol('SUI.merge',SUI.merge);
SUI.format=function(a,b,c,d){c=void 0===c?'\\{':c;d=void 0===d?'\\}':d;SUI.each(void 0===b?null:b,function(b,f){a=a.replace(new RegExp(c+f+d,'gm'),b)});return a};goog.exportSymbol('SUI.format',SUI.format);SUI.convert=function(a,b){var c=a;SUI.isNumber(a)?c=SUI.convertNumber(a,b):SUI.isString(a)&&(c=SUI.convertString(a,b));return c};goog.exportSymbol('SUI.convert',SUI.convert);SUI.convertNumber=function(a,b){var c=a;switch(b){case 'string':c=a.toString()}return c};
goog.exportSymbol('SUI.convertNumber',SUI.convertNumber);SUI.convertString=function(a,b){var c=a;switch(b){case 'integer':c=parseInt(a,10);break;case 'float':c=parseFloat(a)}return c};goog.exportSymbol('SUI.convertString',SUI.convertString);SUI.defaultValue=function(a,b){return SUI.isUndefined(a)?b:a};goog.exportSymbol('SUI.defaultValue',SUI.defaultValue);SUI.noop=function(a){return function(){return a}};goog.exportSymbol('SUI.noop',SUI.noop);SUI.eq=function(a,b){return a===b};
goog.exportSymbol('SUI.eq',SUI.eq);SUI.neq=function(a,b){return a!==b};goog.exportSymbol('SUI.neq',SUI.neq);SUI.gt=function(a,b){return a>b};goog.exportSymbol('SUI.gt',SUI.gt);SUI.gte=function(a,b){return a>=b};goog.exportSymbol('SUI.gte',SUI.gte);SUI.lt=function(a,b){return a<b};goog.exportSymbol('SUI.lt',SUI.lt);SUI.lte=function(a,b){return a<=b};goog.exportSymbol('SUI.lte',SUI.lte);SUI.isArray=function(a){return SUI.instanceOf(a,Array)};goog.exportSymbol('SUI.isArray',SUI.isArray);
SUI.isFunction=function(a){return SUI.is(a,'function')};goog.exportSymbol('SUI.isFunction',SUI.isFunction);SUI.isString=function(a){return SUI.is(a,'string')};goog.exportSymbol('SUI.isString',SUI.isString);SUI.isNumber=function(a){return''!==a&&!isNaN(a)&&(!SUI.inArray(['0','+'],a[0])||'0'===a)};goog.exportSymbol('SUI.isNumber',SUI.isNumber);SUI.isFloat=function(a){return parseFloat(a)===a};goog.exportSymbol('SUI.isFloat',SUI.isFloat);SUI.isInteger=function(a){return parseInt(a,0)===a};
goog.exportSymbol('SUI.isInteger',SUI.isInteger);SUI.isObject=function(a){return SUI.is(a,'object')};goog.exportSymbol('SUI.isObject',SUI.isObject);SUI.isNull=function(a){return null===a};goog.exportSymbol('SUI.isNull',SUI.isNull);SUI.isUndefined=function(a){return SUI.is(a,'undefined')};goog.exportSymbol('SUI.isUndefined',SUI.isUndefined);SUI.isFinite=function(a){return isFinite(a)};goog.exportSymbol('SUI.isFinite',SUI.isFinite);SUI.is=function(a,b){return typeof a===b};
goog.exportSymbol('SUI.is',SUI.is);SUI.instanceOf=function(a,b){return a instanceof b};goog.exportSymbol('SUI.instanceOf',SUI.instanceOf);SUI.each=function(a,b,c,d){SUI.isArray(a)?SUI.eachArray(a,b,c,d):SUI.isObject(a)&&SUI.eachObject(a,b)};goog.exportSymbol('SUI.each',SUI.each);SUI.eachArray=function(a,b,c,d){d=d||a.length;for(c=c||0;c<d;c++)b(a[c],c)};goog.exportSymbol('SUI.eachArray',SUI.eachArray);SUI.eachObject=function(a,b){for(var c in a)a.hasOwnProperty(c)&&b(a[c],c)};
goog.exportSymbol('SUI.eachObject',SUI.eachObject);SUI.sleepEach=function(a,b,c,d){var e=function(){a(b);b++;b<c&&setTimeout(e,d)};e()};goog.exportSymbol('SUI.sleepEach',SUI.sleepEach);SUI.clear=function(a){SUI.isArray(a)?SUI.clearArray(a):SUI.isObject(a)&&SUI.clearObject(a)};goog.exportSymbol('SUI.clear',SUI.clear);SUI.clearArray=function(a){a.splice(0,a.length)};goog.exportSymbol('SUI.clearArray',SUI.clearArray);SUI.clearObject=function(a){for(var b in a)a.hasOwnProperty(b)&&delete a[b]};
goog.exportSymbol('SUI.clearObject',SUI.clearObject);SUI.inArray=function(a,b){return-1!==a.indexOf(b)};goog.exportSymbol('SUI.inArray',SUI.inArray);SUI.contain=function(a,b){return-1!==a.indexOf(b)};goog.exportSymbol('SUI.contain',SUI.contain);SUI.inContainArray=function(a,b){for(var c=0;c<a.length&&!SUI.contain(b,a[c]);)c++;return c<a.length};goog.exportSymbol('SUI.inContainArray',SUI.inContainArray);
SUI.isSame=function(a,b){var c=JSON.stringify(a),d=JSON.stringify(b);if(SUI.isObject(a)&&SUI.isObject(b)&&SUI.eq(c.length,d.length)){var e=!0;SUI.eachObject(a,function(a,c){SUI.isSame(b[c],a)||(e=!1)});return e}return SUI.eq(c,d)};goog.exportSymbol('SUI.isSame',SUI.isSame);SUI.remove=function(a,b){b=a.indexOf(b);SUI.neq(b,-1)&&a.splice(b,1)};goog.exportSymbol('SUI.remove',SUI.remove);
SUI.copy=function(a){if(SUI.isArray(a))var b=[].concat(a);else SUI.isObject(a)&&(b={},SUI.each(a,function(a,d){b[d]=SUI.isObject(a)?SUI.copy(a):a}));return b};goog.exportSymbol('SUI.copy',SUI.copy);SUI.isEmpty=function(a){var b=!1;if(SUI.isArray(a))b=0===a.length;else if(SUI.isObject(a)){var c=0;SUI.each(a,function(){c++});b=0===c}return b};goog.exportSymbol('SUI.isEmpty',SUI.isEmpty);SUI.list=function(a,b){b.apply(null,$jscomp.arrayFromIterable(a))};goog.exportSymbol('SUI.list',SUI.list);
SUI.random=function(a,b,c){return(void 0===c?0:c)?Math.random()*(b-a)+a:Math.floor(Math.random()*(b-a+1))+a};goog.exportSymbol('SUI.random',SUI.random);SUI.encodeBase64=function(a){a=window.CryptoJS.enc.Utf8.parse(a);return window.CryptoJS.enc.Base64.stringify(a)};goog.exportSymbol('SUI.encodeBase64',SUI.encodeBase64);SUI.decodeBase64=function(a){a=window.CryptoJS.enc.Base64.parse(a);return window.CryptoJS.enc.Utf8.stringify(a)};goog.exportSymbol('SUI.decodeBase64',SUI.decodeBase64);
...
goog.exportSymbol('SUI.debounce',SUI.debounce);SUI.urlWithQueryString=function(a,b){b=SUI.getQueryString(b);var c=SUI.contain(a,'?')?'&':'?';return a+(b?c+b:'')};goog.exportSymbol('SUI.urlWithQueryString',SUI.urlWithQueryString);SUI.getQueryString=function(a){var b=[];SUI.each(a,function(a,d){SUI.isArray(a)?SUI.eachArray(a,function(a){b.push(SUI.format('{0}[]={1}',[d,a]))}):SUI.isUndefined(a)||SUI.isNull(a)||b.push(SUI.format('{0}={1}',[d,a]))});return SUI.isEmpty(b)?'':b.join('&')};
...
function(){this.eventServiceFailed()}.bind(this))};SUI.Module.prototype.handleRoutes=function(a,b){this._instances[this._injections.state]=new SUI.State(a,b);this._instances[this._injections.state].eventChange=function(a,b,e){var c=SUI.noop();!b.isEmpty()&&SUI.isObject(this._controller)&&SUI.isFunction(this._controller.exit)&&(c=this._controller.exit.bind(this._controller));(new SUI.Async).serial([c]).then(function(){this._handleStateChange(a,e)}.bind(this))}.bind(this)};
SUI.Module.prototype._handleStateChange=function(a,b){var c=this;b=void 0===b?!1:b;this.eventStateChange(a).then(function(){if(a.get('template')){var d=a.get('templateUrl');c._instances[c._injections.template].load(d,b).then(function(b){c.eventModuleLoaded(a);c._initController(a,b)},function(){c.eventModuleFailed(a)})}else c.eventModuleLoaded(a),c._initController(a,c._instances[c._injections.template].getViewNode())},function(){c.eventModuleFailed(a)})};
...
SUI.Module.prototype.eventServiceFailed=function(){console.warn('SUI.Module.eventServiceFailed()')};SUI.Object=function(a){a=a||{};Object.call(this,a);this.merge(a)};goog.exportSymbol('SUI.Object',SUI.Object);SUI.Object.prototype=Object.create(Object.prototype);SUI.Object.prototype.constructor=SUI.Object;
...
SUI.lib.Window.prototype._scroll=function(a){this.eventScroll(this.getScrollTop(),a)};SUI.lib.Window.prototype.getScrollTop=function(){return this.document.documentElement.scrollTop||this.document.body.scrollTop};SUI.lib.Window.prototype.getWidth=function(){return this.window.innerWidth};SUI.lib.Window.prototype.getHeight=function(){return this.window.innerHeight};SUI.lib.Window.prototype.getOrientation=function(){return SUI.gte(this.getWidth(),this.getHeight())?'landscape':'portrait'};SUI.Application=function(a,b){this._setOptions(a);this._init(b)};SUI.Application.prototype._setOptions=function(a){this.options=new SUI.Object({app_id:'sui-app',title:'SUI-APP',locale:navigator.language,backend:'',production:!1,secret:'f74pej3qpb9qmpvregu7ef33m5w6f6qz',log_color:'#3f51b5'});this.options.merge(a)};
SUI.Application.prototype._init=function(a){this.types={};this._injections=a;this._instances={};this._initCertificate();this._initApp();this._initRoutes();this._initStorage();this._initLocale();this._initModule();this._initEvent();this._initScheduler();this._initLoader();this._initHttp();this._initDialog();this._initConfirm();this._initViewer();this._initProgressBar();this._initCookie();this._initNotification();this._initTemplate();this._initDocument();this._initWindow();this._initHelper();this._initHeader();
this._initTopMenu();this._initLeftMenu();this._initNavBar();this._initSidebar();this._initFooter();this._initBottomMenu();this._initBrowser();this._initGeoLocation();this._initScript();this._initStyle();this._initConfig();this._initConsole();this._initAppCache();this._initServiceWorker();this._initActionCable();this._loadModules()};SUI.Application.prototype.getLanguage=function(){return this.getLocale().split('-',2)[0]};
SUI.Application.prototype.getLocale=function(){var a=this._instances[this._injections.localStorage].get('app.locale');a||(a=this.options.locale);return a};SUI.Application.prototype.setLocale=function(a){this._instances[this._injections.localStorage].set('app.locale',a);this.options.locale=a};SUI.Application.prototype.setLocaleWithReload=function(a){this.setLocale(a);this._instances[this._injections.state].reload()};
SUI.Application.prototype._initLocale=function(){var a=this.getLocale();window.moment.locale(a);this.setLocale(a)};SUI.Application.prototype._initCertificate=function(){(new SUI.Query('html')).getItem().addClass('sui-js')};
SUI.Application.prototype._initModule=function(){var a=this;this._module=new SUI.Module;this._module.eventAfterInit=function(){a._instances[a._injections.progressBar].lock();a._instances[a._injections.loader].show();a._instances[a._injections.event].call('module.afterInit')};this._module.eventStateChange=function(b){a._instances[a._injections.progressBar].lock();a._instances[a._injections.loader].show();a._instances[a._injections.dialog].close();a._instances[a._injections.confirm].close();a._instances[a._injections.actionCable].unsubscribeAll();
...
SUI.Application.prototype._initDocument=function(){var a=new SUI.PopupContainer;this._instances[this._injections.document]=new SUI.lib.Document(this.options);this._instances[this._injections.document].eventClick=function(b,c){a.closeAll();this._instances[this._injections.event].call('document.click',[b,c])}.bind(this)};
...
b);this._instances[this._injections.confirm].setSize(a,b);this._instances[this._injections.viewer].setSize(a,b);this._instances[this._injections.event].call('window.resize',[a,b,c])}.bind(this);this._instances[this._injections.window].eventOrientationChange=function(a,b,c,g){this._instances[this._injections.dialog].setSize(b,c);this._instances[this._injections.confirm].setSize(b,c);this._instances[this._injections.viewer].setSize(b,c);this._instances[this._injections.event].call('window.orientationChange',
[a,b,c,g])}.bind(this);this._instances[this._injections.window].eventScroll=function(a,b){this._instances[this._injections.event].call('window.scroll',[a,b])}.bind(this);var c={node:null,message:'Unable to connect to the Internet',duration:Infinity};this._instances[this._injections.window].eventOnline=function(){c.node&&this._instances[this._injections.notification].remove(c.node)}.bind(this);this._instances[this._injections.window].eventOffline=function(a){this._instances[this._injections.event].override('window.offline',
[c,a],function(a){a.node=this._instances[this._injections.notification].addWarning(a.message,a.duration)}.bind(this))}.bind(this)};SUI.Application.prototype._initEvent=function(){this._instances[this._injections.event]=new SUI.lib.Event};SUI.Application.prototype._initScheduler=function(){this._instances[this._injections.scheduler]=new SUI.lib.Scheduler};
...
SUI.Application.prototype._initBrowser=function(){var a=this;this._instances[this._injections.browser]=new SUI.lib.Browser;this._instances[this._injections.browser].eventMissingFeatures=function(b){a._instances[a._injections.notification].addError(b.join(', '))}};SUI.Application.prototype._initAppCache=function(){var a=this;this._instances[this._injections.appCache]=new SUI.lib.AppCache;this._instances[this._injections.appCache].eventMissingFeatures=function(b){a._instances[a._injections.notification].addError(b.join(', '))}};
SUI.Application.prototype._initServiceWorker=function(){var a=this;this._instances[this._injections.serviceWorker]=new SUI.lib.ServiceWorker;this._instances[this._injections.serviceWorker].eventMissingFeatures=function(b){a._instances[a._injections.notification].addError(b.join(', '))}};SUI.Application.prototype._initActionCable=function(){this._instances[this._injections.actionCable]=new SUI.lib.ActionCable};SUI.Application.prototype._initRoutes=function(){this._routes=[];this._routeOptions=new SUI.Object};
SUI.Application.prototype.addState=function(a,b,c,d,e,f){e=void 0===e?'':e;f=void 0===f?{}:f;f=new SUI.Object(f);f.set('id',a);f.set('title',b);f.set('url',c);f.set('controller',d);f.set('template',e);this._routes.push(f)};SUI.Application.prototype.setRootState=function(a,b){this._routeOptions.set('root.id',a);this._routeOptions.set('root.params',b)};SUI.Application.prototype.setHomeState=function(a,b){this._routeOptions.set('home.id',a);this._routeOptions.set('home.params',b)};
SUI.Application.prototype.setMaintenanceState=function(a,b){this._routeOptions.set('maintenance.id',a);this._routeOptions.set('maintenance.params',b)};SUI.Application.prototype.getInstance=function(a){return this._instances[a]};SUI.Application.prototype.getController=function(){return this._module.getController()};
SUI.Application.prototype.run=function(){this.options.production?console.info('%cApplication run in production environment...','font-weight:bold;color:'+this.options.log_color+';'):(console.info('%cApplication run in development environment...','font-weight:bold;color:'+this.options.log_color+';'),(new SUI.Test).run());this._module.handleRoutes(this._routes,this._routeOptions);this._module.handleServices()};goog.exportProperty(SUI.Application.prototype,'run',SUI.Application.prototype.run);
SUI.Application.prototype.controller=function(a,b,c,d){this._module.add(a,b,c,d)};SUI.Application.prototype.service=function(a,b,c,d){this._module.add(a,b,c,d)};SUI.Application.prototype.factory=function(a,b,c,d){this.service(a,b,c,d)};SUI.Item=function(a,b){this.properties=new SUI.Object(a);this.parent=b};SUI.Item.prototype.set=function(a,b){this.properties.set(a,b)};SUI.Item.prototype.merge=function(a){this.properties.merge(a)};SUI.Item.prototype.get=function(a){return this.properties.get(a)};SUI.Router=function(a){this.route=void 0===a?'':a;this.param=/([:*])(\w+)/g;this.escape=/[-[]{}()+?.,]/g;this._init()};SUI.Router.prototype._init=function(){var a=this;this.paramNames=[];this.regex=this.route;this.regex=this.regex.replace(this.escape,'\\$&');this.regex=this.regex.replace(this.param,function(b,c,d){a.paramNames.push(d);return':'===c?'([^/]*)':'(.*)'});this.regex=new RegExp('^'+this.regex+'$')};
SUI.Router.prototype.stringify=function(a){a=void 0===a?{}:a;var b=this.route,c={},d;for(d in a){c.$jscomp$loop$prop$key$13=d;if(a.hasOwnProperty(c.$jscomp$loop$prop$key$13)){var e=a[c.$jscomp$loop$prop$key$13],f=new RegExp('[:*]'+c.$jscomp$loop$prop$key$13+'\\b');f.test(b)?b=b.replace(f,e):(b+=-1===b.indexOf('?')?'?':'&',SUI.isArray(e)?SUI.eachArray(e,function(a){return function(c,d){0<d&&(b+='&');b+=SUI.format('{0}[]={1}',[a.$jscomp$loop$prop$key$13,c])}}(c)):SUI.isUndefined(e)||(b+=SUI.format('{0}={1}',
[c.$jscomp$loop$prop$key$13,e])))}c={$jscomp$loop$prop$key$13:c.$jscomp$loop$prop$key$13}}b=b.replace(this.param,'');return'?'===b[b.length-1]?b.substring(0,b.length-1):b};SUI.Router.prototype.getMatches=function(a){var b=a.indexOf('?');-1!==b&&(a=a.substring(0,b));return a.match(this.regex)};SUI.Router.prototype.parse=function(a){var b=this.getMatches(a);if(!b)return{};a=this._parseParams(a);for(var c=0;c<this.paramNames.length;c++)a[this.paramNames[c]]=SUI.typeCast(b[c+1]);return a};
...
SUI.widget.Select.prototype.setOptions=function(a,b,c,d){var e=this;b=void 0===b?'value':b;c=void 0===c?'name':c;d=void 0===d?'':d;(new SUI.Query('option',this.input)).each(function(a){a.getAttribute('value')&&a.remove()});SUI.each(a,function(a){var f=a.get(b),h=a.get(c),k='';d&&(k=a.get(d));var l=new SUI.Node('option');l.setAttribute('value',f);l.setAttribute('data-image',k);l.setAttribute('data-item',a);l.setHtml(h);e.input.appendChild(l)});this._initOptions();this._hideLoader();this.setValue(this.ids)};
...
SUI.TabPanel.prototype.setActive=function(a){var b=this,c=new SUI.Deferred;SUI.isNull(a)?c.reject():(this._setActive(a),(new SUI.Async).serial([function(){return b.eventChange(b.getActive())}]).defer(c));return c.promise()};SUI.TabPanel.prototype.getActive=function(){return this.activeTab};SUI.Table=function(a,b,c){c=void 0===c?{}:c;this.tableNode=(new SUI.Query(void 0===b?'table':b,a)).getItem();this._setOptions(c);this._init()};SUI.Table.prototype._setOptions=function(a){a=void 0===a?{}:a;this.options=new SUI.Object({no_content:{image_url:null,text:''},row_count:10,pager_num:4,sort:{column:null,order:'desc'},columns:[],calculations:{},sorted:[],column:null});this.options.merge(a)};
SUI.Table.prototype._init=function(){this.collection=new SUI.Collection;this.query='';this.actions=[];this.tableNode.getId()||(this.tableNode.setId(SUI.generateId('table')),this._initContentHandler(),this._initHeader(),this._initSearch(),this._initStructure())};SUI.Table.prototype._initContentHandler=function(){this.contentHandler=new SUI.ContentHandler(this.tableNode,this.options.no_content)};
...
SUI.Waiter.prototype._simpleDelayHandler=function(a,b,c){var d=this;this.counter++;setTimeout(function(){c===d.counter-1&&(d.counter=0,a())},b)};SUI.test.Container=function(){SUI.Test.call(this,'Container')};goog.inherits(SUI.test.Container,SUI.Test);SUI.test.Container.prototype.init=function(){this.container=new SUI.Collection([{id:1,text:'text'},{id:2,text:'text2'}]);this.testInit();this.testLoad()};SUI.test.Container.prototype.testInit=function(){};SUI.test.Container.prototype.testLoad=function(){};SUI.test.Deferred=function(){SUI.Test.call(this,'Deferred')};goog.inherits(SUI.test.Deferred,SUI.Test);
SUI.test.Deferred.prototype.init=function(){this.ajaxResolve=function(){var a=new SUI.Deferred;window.setTimeout(function(){a.resolve(1)},100);return a.promise()};this.funcResolve=function(){var a=new SUI.Deferred;a.resolve(2);return a.promise()};this.ajaxReject=function(){var a=new SUI.Deferred;window.setTimeout(function(){a.reject(1)},100);return a.promise()};this.funcReject=function(){var a=new SUI.Deferred;a.reject(2);return a.promise()};this.testPromise();this.testResolve();this.testReject()};
SUI.test.Deferred.prototype.testPromise=function(){(new SUI.Deferred).promise()instanceof SUI.Promise||this.showError('promise',1)};SUI.test.Deferred.prototype.testResolve=function(){var a=this;this.ajaxResolve().then(function(b){1!==b&&a.showError('resolve',1)},function(){a.showError('resolve',2)});this.funcResolve().then(function(b){2!==b&&a.showError('resolve',3)},function(){a.showError('resolve',4)})};
SUI.test.Deferred.prototype.testReject=function(){var a=this;this.ajaxReject().then(function(){a.showError('reject',1)},function(b){1!==b&&a.showError('reject',2)});this.funcReject().then(function(){a.showError('reject',3)},function(b){2!==b&&a.showError('reject',4)})};SUI.test.Item=function(){SUI.Test.call(this,'Item')};goog.inherits(SUI.test.Item,SUI.Test);SUI.test.Item.prototype.init=function(){this.item=new SUI.Item(this,{attr1:2,obj1:{attr2:3.1}});this.testGet();this.testSet();this.testMerge()};SUI.test.Item.prototype.testGet=function(){this.item.set('attr1',2);2!==this.item.get('attr1')&&this.showError('get',1);this.item.set('obj1.attr2',3.1);3.1!==this.item.get('obj1.attr2')&&this.showError('get',2)};
SUI.test.Item.prototype.testSet=function(){this.item.set('attr1',3);3!==this.item.get('attr1')&&this.showError('set',1);this.item.set('obj1.attr5',5.34);5.34!==this.item.get('obj1.attr5')&&this.showError('set',2)};
SUI.test.Item.prototype.testMerge=function(){this.item.merge({attr1:1,obj1:{obj2:{attr4:null}},attr3:null});this.item.set('attr1',1);1!==this.item.get('attr1')&&this.showError('merge',1);this.item.set('obj1.attr2',3.1);3.1!==this.item.get('obj1.attr2')&&this.showError('merge',2);this.item.set('obj1.obj2.attr4',null);null!==this.item.get('obj1.obj2.attr4')&&this.showError('merge',3);this.item.set('attr3',null);null!==this.item.get('attr3')&&this.showError('merge',4)};SUI.test.Node=function(){SUI.Test.call(this,'Node')};goog.inherits(SUI.test.Node,SUI.Test);SUI.test.Node.prototype.init=function(){this.node=new SUI.Node('div');this.testAttribute();this.testAttributeData();this.testData()};
SUI.test.Node.prototype.testAttribute=function(){for(var a=['text',null,!0,!1,Infinity,0,1,10],b=0;b<a.length;b++){this.node.setAttribute('data',a[b]);var c=this.node.getAttribute('data');SUI.isSame(c,a[b])||(this.showError('setAttribute(data)',a[b]),this.showError('getAttribute(data)',c))}};
SUI.test.Node.prototype.testAttributeData=function(){for(var a=['text',null,!0,!1,Infinity,0,1,10,[0,1,10],{key:'value'}],b=0;b<a.length;b++){this.node.setAttribute('data-value',a[b]);var c=this.node.getAttribute('data-value');SUI.isSame(c,a[b])||(this.showError('setAttribute(data-value)',a[b]),this.showError('getAttribute(data-value)',c))}this.node.removeAttribute('data-value')};
SUI.test.Node.prototype.testData=function(){for(var a=['','text',null,!0,!1,void 0,Infinity,0,1,10,[0,1,10],{key:'value'}],b=0;b<a.length;b++){this.node.setData('value',a[b]);var c=this.node.getData('value');SUI.isSame(c,a[b])||(this.showError('setData(value)',a[b]),this.showError('getData(value)',c))}this.node.removeData('value')};SUI.test.Object=function(){SUI.Test.call(this,'Object')};goog.inherits(SUI.test.Object,SUI.Test);SUI.test.Object.prototype.init=function(){this.testMerge();this.testGetTypedValue();this.testGet();this.testSet();this.testRemove();this.testCopy()};
SUI.test.Object.prototype.testMerge=function(){var a=new SUI.Object({attr:null,obj:{attr2:1,attr4:3}});null!==a.attr&&this.showError('merge',1);a.merge({attr:'value1',obj:{attr2:2,attr3:null}});'value1'!==a.attr&&this.showError('merge',2);2!==a.obj.attr2&&this.showError('merge',3);null!==a.obj.attr3&&this.showError('merge',4);3!==a.obj.attr4&&this.showError('merge',5)};
SUI.test.Object.prototype.testGetTypedValue=function(){var a=new SUI.Object({attr:'null',obj:{attr2:'1',attr3:'3.2'},attr4:'false',attr5:'true',attr6:'string123,456.789',attr7:void 0,attr8:null});null!==a.attr&&this.showError('_getTypedValue',0);1!==a.obj.attr2&&this.showError('_getTypedValue',1);3.2!==a.obj.attr3&&this.showError('_getTypedValue',2);!1!==a.attr4&&this.showError('_getTypedValue',3);!0!==a.attr5&&this.showError('_getTypedValue',4);'string123,456.789'!==a.attr6&&this.showError('_getTypedValue',
5);void 0!==a.attr7&&this.showError('_getTypedValue',6);null!==a.attr8&&this.showError('_getTypedValue',7)};
SUI.test.Object.prototype.testGet=function(){var a=new SUI.Object({attr:null,obj:{attr2:1,obj2:{attr4:2,attr3:3.2,attr5:4.5}}});a.set('attr',null);null!==a.get('attr')&&this.showError('get',0);a.set('obj.attr2',1);1!==a.get('obj.attr2')&&this.showError('get',1);a.set('obj.obj2.attr3',3.2);3.2!==a.get('obj.obj2.attr3')&&this.showError('get',2);void 0!==a.get('obj.obj3')&&this.showError('get',3)};
SUI.test.Object.prototype.testSet=function(){var a=new SUI.Object({attr:0,obj:{attr2:0,obj2:{attr3:0}}});a.set('attr',null);null!==a.get('attr')&&this.showError('set',0);a.set('obj.attr2',1);1!==a.get('obj.attr2')&&this.showError('set',1);a.set('obj.obj2.attr3',3.2);3.2!==a.get('obj.obj2.attr3')&&this.showError('set',2);a.set('obj.obj3',5);void 0===a.get('obj.obj3')&&this.showError('set',3)};
SUI.test.Object.prototype.testRemove=function(){var a=new SUI.Object({attr:0,obj:{attr2:0,obj2:{attr3:0}}});a.remove('attr');void 0!==a.get('attr')&&this.showError('remove',0);a.remove('obj.attr2');void 0!==a.get('obj.attr2')&&this.showError('remove',1);a.remove('obj.obj2.attr3');void 0!==a.get('obj.obj2.attr3')&&this.showError('remove',2);a.remove('obj.obj3');void 0!==a.get('obj.obj3')&&this.showError('remove',3)};
SUI.test.Object.prototype.testCopy=function(){var a=new SUI.Object({attr:0,obj:{attr2:0,obj2:{attr3:0}}});a.set('obj.attr2',0);a.copy().remove('obj.attr2');0!==a.get('obj.attr2')&&this.showError('copy',0)};SUI.widget.AutoComplete=function(a,b,c,d){SUI.Widget.call(this,a,b,c,d);this._init()};goog.inherits(SUI.widget.AutoComplete,SUI.Widget);SUI.widget.AutoComplete.prototype._init=function(){};SUI.widget.DatetimeRange=function(a,b,c,d,e){SUI.Widget.call(this,a,b,c,d);this.isStartInput=e;this._init()};goog.inherits(SUI.widget.DatetimeRange,SUI.Widget);
