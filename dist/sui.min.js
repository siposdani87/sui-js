...
e.replace=function(a){var b=a.get(this.options.id);(b=ha(this,this.options.id,b))&&b.j(a);return b};e.iterator=function(a,b,c){c=c||this.c;var d=[];x(c,function(f,g){a(f)&&(b(f,g),d.push(f))});return d};e.l=function(a){this.iterator(function(){return!0},a)};e.get=function(a,b){var c=null;0<=a&&a<this.c.length&&(c=a=this.c[a],b&&(c=a.get(b)));return c};e.clear=function(){J(this.c)};function ha(a,b,c){return ia(a,function(d,f){return a.get(f,b)===c})}
...
e.o=function(){return this.node};e.setAttribute=function(a,b){b=A(b)?a:b;E(b)?this.node[a]=b:q(a,'data-')&&v(b)?this.node.setAttribute(a,JSON.stringify(b)):this.node.setAttribute(a,b)};e.addEventListener=function(a,b){var c=this,d=B();b&&(d=function(f){b(c,f);f.stopPropagation()},this.node.addEventListener(a,d),ka(this,a,d));return d};function ka(a,b,c){a.node._listeners||(a.node._listeners={});a.node._listeners[b]||(a.node._listeners[b]=[]);a.node._listeners[b].push(c)}
