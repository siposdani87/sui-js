...
afterAll(() => {
    logSpy === null || logSpy === void 0 ? void 0 : logSpy.mockRestore();
    errorSpy === null || errorSpy === void 0 ? void 0 : errorSpy.mockRestore();
    infoSpy === null || infoSpy === void 0 ? void 0 : infoSpy.mockRestore();
});
