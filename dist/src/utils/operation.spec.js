import { convertToString, eq, format, gt, gte, instanceOf, is, isArray, isDate, isFloat, isFunction, isInteger, isNull, isNumber, isObject, isString, isUndefined, lt, lte, merge, neq, noop, typeCast, } from './operation';
describe('operation', () => {
