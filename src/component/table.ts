import { generateId, eq, mdl, inArray, contain, consoleWarn, format, isFunction, isArray, each, eachArray, instanceOf } from "../base";
 ...
 */
export const Table = function(dom, opt_selector = 'table', opt_options = {}) {
 ...
 * @return {undefined}
 */
Table.prototype._setOptions = function(opt_options = {}) {
  const _self = this;
 ...
 * @return {undefined}
 */
Table.prototype._initContentHandler = function() {
 ...
 * @return {undefined}
 */
Table.prototype._initSearch = function() {
 ...
 * @return {undefined}
 */
Table.prototype._renderHeader = function(headerNode, columnIndex) {
 ...
 * @return {undefined}
 */
Table.prototype._initStructure = function() {
 ...
 * @return {undefined}
 */
Table.prototype.refresh = function(opt_page = -1) {
  if (opt_page > -1) {
 ...
 * @return {undefined}
 */
Table.prototype.eventAction = function(params) {
 ...
 * @return {undefined}
 */
Table.prototype._toggleSorting = function(columnWithOrder) {
  let [column, order] = columnWithOrder.split(':', 2);
  order = order || 'desc';
  if (eq(this.options.sort.column, column) && eq(this.options.sort.order, order)) {
 ...
 * @return {undefined}
 */
Table.prototype._handleSortingColumn = function(head, i) {
  const column = this.options.columns[i];
  if ((eq(this.options.sort.column, null) && eq(i, 0)) || eq(column, this.options.sort.column)) {
 ...
 * @return {undefined}
 */
Table.prototype._updateSorting = function() {
  this._resetSorting();
 ...
 * @return {undefined}
 */
Table.prototype._setSorting = function(column, opt_order = 'asc') {
 ...
 * @return {undefined}
 */
Table.prototype._resetSorting = function() {
 ...
 * @return {string}
 */
Table.prototype._getColumn = function() {
 ...
 * @return {undefined}
 */
Table.prototype._addHeaderRow = function(item, rowIndex) {
 ...
 * @return {!Array<string>}
 */
Table.prototype._getRowStyle = function(item, rowIndex) {
  let results = [];
 ...
 * @return {undefined}
 */
Table.prototype._addRow = function(item, rowIndex) {
 ...
 * @return {undefined}
 */
Table.prototype.setActions = function(actions) {
 ...
 * @return {undefined}
 */
Table.prototype._renderDataNodeByItem = function(item, rowIndex, column, parentNode) {
  let result = '';
  ...
  if (!isArray(result)) {
    ...
    items = /** @type {!Array} */(result as any);
  }
 ...
 * @return {undefined}
 */
Table.prototype._renderDataNode = function(tableDataNode, item, rowIndex, column, columnIndex) {
  if (inArray(['search', 'actions'], column)) {
 ...
 * @return {undefined}
 */
Table.prototype._renderActions = function(tableDataNode, item) {
 ...
 * @return {undefined}
 */
Table.prototype._renderActionNodes = function(containerNode, item) {
 ...
 * @return {undefined}
 */
Table.prototype._renderDropDownNode = function(dropDownNode, item) {
 ...
 * @return {undefined}
 */
Table.prototype._createActionButton = function(containerNode, action, item) {
 ...
 * @return {undefined}
 */
Table.prototype.setData = function(items) {
 ...
 * @return {!Array}
 */
Table.prototype._getItems = function() {
