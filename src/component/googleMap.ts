import { consoleInfo, each, inArray, isUndefined, eachObject, convert, mapText } from "../base";
 ...
 */
export const GoogleMap = function(dom, opt_selector = '.map', opt_options = {}) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._setOptions = function(opt_options = {}) {
  const _self = this;
 ...
 * @return {string}
 */
GoogleMap.prototype.getMapType = function() {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.setMapType = function(mapTypeId) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.setCustomMapStyle = function(mapTypeId, mapTypeName, mapStyles) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._bindEventsToMap = function() {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._unbindEventsToMap = function() {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._initOverlay = function() {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventPolygonChanged = function(polygonData, points) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.createOrUpdatePolygon = function(id, title, points, opt_polygonData = {}, opt_options = {}) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.createPolygon = function(id, title, points, opt_polygonData = {}, opt_options = {}) {
  ...
  const text = mapText(title, new google.maps.LatLng(latLng.latitude, latLng.longitude), this.map);
 ...
 * @return {undefined}
 */
GoogleMap.prototype.updatePolygon = function(id, title, points, opt_polygonData = {}, opt_options = {}) {
 ...
 * @return {!Objekt}
 */
GoogleMap.prototype._cleanPolygonData = function(polygonData) {
 ...
 * @return {!Objekt}
 */
GoogleMap.prototype.getPolygon = function(id) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.removePolygon = function(id) {
  const polygonData = this.getPolygon(id);
  if (polygonData) {
    const mapText = polygonData.get('_map_text');
 ...
 * @return {undefined}
 */
GoogleMap.prototype.removeAllPolygon = function() {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._bindEventsToPolygon = function(polygon, polygonData) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._unbindEventsToPolygon = function(polygon) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._bindEventsToPolygonPath = function(polygon, polygonData) {
  const path = polygon.getPath();
  if (path) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._unbindEventsToPolygonPath = function(polygon) {
  const path = polygon.getPath();
  if (path) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._callPolygonChangeEvent = function(polygon, polygonData) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventPolygonClick = function(polygonData, latitude, longitude, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventPolygonDoubleClick = function(polygonData, latitude, longitude, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventPolygonRightClick = function(polygonData, latitude, longitude, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventMapClick = function(latitude, longitude, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventMapTypeChange = function(mapType, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._addPointsToPolygon = function(polygonData, points) {
  const polygon = /** @type {!google.maps.Polygon} */ (polygonData.get('_polygon'));
 ...
 */
GoogleMap.prototype._convertPointsToPath = function(points) {
  const path = [];
  each(points, (point) => {
    let vertex: any = new google.maps.LatLng(point.latitude, point.longitude);
 ...
 * @return {undefined}
 */
GoogleMap.prototype._setBoundsByPoints = function(polygonData, points) {
  const path = this._convertPointsToPath(points);
  this._setBoundsByPath(polygonData, path);
};
 ...
 * @return {undefined}
 */
GoogleMap.prototype._setBoundsByPath = function(polygonData, path) {
 ...
 */
GoogleMap.prototype.getCenterOfPolygon = function(polygonData) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.fitPolygonToMap = function(polygonId) {
 ...
 */
GoogleMap.prototype._getPointsFromPolygon = function(polygonData) {
  const polygon = /** @type {!google.maps.Polygon} */ (polygonData.get('_polygon'));
 ...
 * @return {number}
 */
GoogleMap.prototype.getComputeArea = function(polygonData) {
  const polygon = /** @type {!google.maps.Polygon} */ (polygonData.get('_polygon'));
  const path = polygon.getPath();
 ...
 * @return {undefined}
 */
GoogleMap.prototype.addPointToPolygon = function(polygonData, latitude, longitude) {
  const polygon = /** @type {!google.maps.Polygon} */ (polygonData.get('_polygon'));
  const path = polygon.getPath();
 ...
 * @return {undefined}
 */
GoogleMap.prototype.setMarkers = function(opt_options = {}) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.setHeatmap = function(opt_options = {}) {
  const gradient = [
    'rgba(102, 255, 0, 0)',
    'rgba(102, 255, 0, 1)',
    'rgba(147, 255, 0, 1)',
 ...
 * @return {undefined}
 */
GoogleMap.prototype.createHeatmap = function(points, opt_heatmapOptions = {}) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.removeHeatmap = function() {
  if (this.heatmap) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.setPolygons = function(opt_options = {}) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.createOrUpdateMarker = function(id, title, iconName, latitude, longitude, opt_markerData = {}, opt_options = {}) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.createMarker = function(id, title, iconName, latitude, longitude, opt_markerData = {}, opt_options = {}) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.createMarkerByXY = function(id, title, iconName, x, y, markerData = {}) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._bindEventsToMarker = function(marker, markerData) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype._unbindEventsToMarker = function(marker) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.updateMarker = function(id, title, iconName, latitude, longitude, opt_markerData = {}, opt_options = {}) {
 ...
 * @return {!Objekt}
 */
GoogleMap.prototype._cleanMarkerData = function(markerData) {
  const cleanData = new Objekt();
 ...
 * @return {undefined}
 */
GoogleMap.prototype.fitMarkerToMap = function(markerId) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.openInfoWindow = function(markerId, content) {
  const markerData = this.getMarker(markerId);
  const marker = /** @type {!google.maps.Marker} */ (markerData.get('_marker'));
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventMarkerClick = function(markerData, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventMarkerDoubleClick = function(markerData, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventMarkerRightClick = function(markerData, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.eventMarkerChanged = function(markerData, latitude, longitude, event) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.setMarkerIcon = function(name, iconOptions) {
 ...
 * @return {!Promize}
 */
GoogleMap.prototype.searchAddress = function(query) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.setCenter = function(latitude, longitude, opt_boundCheck = false) {
 ...
 * @return {undefined}
 */
GoogleMap.prototype.triggerResize = function() {
 ...
 * @return {number}
 */
GoogleMap.prototype.getDinamicRadius = function(radiusPx) {
