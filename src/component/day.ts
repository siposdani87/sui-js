...
/**
 * Represents a single day cell in the {@link Calendar} grid, with CSS classes for current, now, and month context.
 * @example
...
export class Day extends Emitter {
    ...
    /**
     * Computes CSS classes for 'current' and 'now' states based on date comparisons.
     */
    private _init(): void {
        const current =
    ...
    /**
     * Creates and returns a styled {@link Knot} element representing this day cell with a click handler.
