import { isUndefined, contain, eq } from "../base";
 ...
 */
export const Navigation = function(opt_http, opt_options = {}) {
  this.http = opt_http;
 ...
 * @return {undefined}
 */
Navigation.prototype._setOptions = function(opt_options = {}) {
  const _self = this;
 ...
 * @return {undefined}
 */
Navigation.prototype.add = function(item) {
 ...
 * @return {undefined}
 */
Navigation.prototype.addCounter = function(id, counter, title, action, opt_href = '', opt_data = {}) {
 ...
 * @return {undefined}
 */
Navigation.prototype.addIcon = function(id, icon, title, action, opt_href = '', opt_data = {}) {
  const item = this._setItem(id, title, action, opt_href, opt_data);
 ...
 * @return {undefined}
 */
Navigation.prototype.addImage = function(id, image, title, action, opt_href = '', opt_data = {}) {
  const item = this._setItem(id, title, action, opt_href, opt_data);
 ...
 * @return {undefined}
 */
Navigation.prototype.addText = function(id, title, action, opt_href = '', opt_data = {}) {
 ...
 * @return {!Objekt}
 */
Navigation.prototype._setItem = function(id, title, action, opt_href = '', opt_data = {}) {
 ...
 * @return {undefined}
 */
Navigation.prototype.each = function(next) {
 ...
 * @return {undefined}
 */
Navigation.prototype.bindToContainer = function(containerNode) {
 ...
 * @return {undefined}
 */
Navigation.prototype.setDisabled = function(id) {
 ...
 * @return {undefined}
 */
Navigation.prototype._disabled = function(item) {
  const linkNode = item.get(this.linkNodeKey);
 ...
 * @return {undefined}
 */
Navigation.prototype.setEnabled = function(id) {
  const item = this.container.findById(id);
  if (item) {
    this._enabled(item);
  }
 ...
 * @return {undefined}
 */
Navigation.prototype._enabled = function(item) {
  this._disabled(item);
  const linkNode = item.get(this.linkNodeKey);
...
Navigation.prototype.setActive = function(id) {
  this.each((item) => {
    ...
    if (itemId[itemId.length - 1] === '.' && contain(id, itemId) || eq(id, itemId)) {
 ...
 * @return {undefined}
 */
Navigation.prototype.setAllInactive = function() {
  this.each((item) => {
    const linkNode = item.get(this.linkNodeKey);
    linkNode.removeClass('active');
  });
 ...
 * @return {undefined}
 */
Navigation.prototype.show = function(id) {
  const item = this.container.findById(id);
  if (item) {
    const linkNode = item.get(this.linkNodeKey);
 ...
 * @return {undefined}
 */
Navigation.prototype.hide = function(id) {
  const item = this.container.findById(id);
  if (item) {
    const linkNode = item.get(this.linkNodeKey);
