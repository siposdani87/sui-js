import { consoleWarn, isNull } from "../base";
 ...
 */
export const TabPanel = function(dom, opt_selector = '.tab-panel', opt_selectedTab = '', opt_defaultTab = '') {
 ...
 * @return {undefined}
 */
TabPanel.prototype._init = function() {
  this._initTabs();
  this._initPanels();
 ...
 * @return {undefined}
 */
TabPanel.prototype._initTabs = function() {
 ...
 * @return {undefined}
 */
TabPanel.prototype._initPanels = function() {
 ...
 * @return {undefined}
 */
TabPanel.prototype._setActive = function(panelId) {
 ...
 * @return {undefined}
 */
TabPanel.prototype.eventChange = function(panelId) {
 ...
 * @return {!Promize}
 */
TabPanel.prototype.setActive = function(panelId) {
