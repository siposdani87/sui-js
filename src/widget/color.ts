import { typeCast, RGBToHEX } from "../base";
 ...
 */
export const Color = function(input, label, error, inputBlock) {
  BaseWidget.call(this, input, label, error, inputBlock);
  this._init();
};
Color.prototype = Object.create(BaseWidget.prototype);
 ...
 * @return {undefined}
 */
Color.prototype._initInput = function() {
 ...
 * @return {undefined}
 */
Color.prototype._initPreview = function() {
 ...
 * @return {undefined}
 */
Color.prototype._draw = function() {
  if (!this.image.isEmpty()) {
    const width = /** @type {number} */ (typeCast(this.image.getAttribute('width')));
    const height = /** @type {number} */ (typeCast(this.image.getAttribute('height')));
 ...
 * @return {undefined}
 */
Color.prototype._initImage = function() {
  ...
  this.canvas.canvasNode.addEventListener('click', (_image, e) => {
    ...
    const hex = RGBToHEX.apply(null, /** @type {!Array} */(rgb));
 ...
 * @return {undefined}
 */
Color.prototype._setMaterialColors = function() {
