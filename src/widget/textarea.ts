 ...
 */
export const Textarea = function(input, label, error, inputBlock) {
  BaseWidget.call(this, input, label, error, inputBlock);
  this._init();
};
Textarea.prototype = Object.create(BaseWidget.prototype);
 ...
 * @return {undefined}
 */
Textarea.prototype._renderRichText = function() {
 ...
 * @return {boolean}
 */
Textarea.prototype._isRichText = function() {
 ...
 * @return {undefined}
 */
Textarea.prototype._renderToolbarButtons = function() {
 ...
 * @return {undefined}
 */
Textarea.prototype._renderToolbarButton = function(iconName, action) {
 ...
 * @return {undefined}
 */
Textarea.prototype._setHtmlMode = function(value) {
  this.htmlMode = value;
 ...
 * @return {boolean}
 */
Textarea.prototype._isHtmlMode = function() {
 ...
 * @return {undefined}
 */
Textarea.prototype._formatDoc = function(sCmd, opt_sValue) {
  if (!this._isHtmlMode()) {
 ...
 * @return {undefined}
 */
Textarea.prototype._setDocMode = function(_isHtmlMode) {
  if (_isHtmlMode) {
 ...
 * @return {undefined}
 */
Textarea.prototype._setValue = function(value) {
