import { contain, encodeBase64, format, mdl, isObject, getExtensionName } from "../base";
 ...
 */
export const File = function(input, label, error, inputBlock) {
  BaseWidget.call(this, input, label, error, inputBlock);
  this._init();
};
File.prototype = Object.create(BaseWidget.prototype);
 ...
 * @return {boolean}
 */
File.prototype._isDocument = function() {
  const accept = /** @type {string} */ (this.input.getAttribute('accept'));
  return contain(accept, '.docx') || contain(accept, '.xlsx') || contain(accept, '.pdf');
};
 ...
 * @return {undefined}
 */
File.prototype._initDefaultImg = function() {
 ...
 * @return {undefined}
 */
File.prototype._initValueSrc = function() {
 ...
 * @return {undefined}
 */
File.prototype._initRemoveButton = function() {
 ...
 * @return {undefined}
 */
File.prototype._initButtons = function() {
 ...
 * @return {!Array}
 */
File.prototype._lookupByMimeType = function(mimeType) {
 ...
 * @return {!Array}
 */
File.prototype._lookupByExtension = function(extension) {
  let results = [];
 ...
 * @return {undefined}
 */
File.prototype._initFileIcon = function() {
  this.fileTypes = {
 ...
 * @return {string}
 */
File.prototype._getFileIconSrc = function(type, color) {
 ...
 * @return {undefined}
 */
File.prototype._read = function(file) {
  if (file) {
    ...
    reader.onload = (event) => {
      ...
      let imageSrc = /** @type {string} */ ((target.result as string).replace(searchStr, ';filename=' + filename + searchStr));
 ...
 * @return {undefined}
 */
File.prototype._handleRemoveButton = function() {
 ...
 * @return {undefined}
 */
File.prototype._remove = function() {
