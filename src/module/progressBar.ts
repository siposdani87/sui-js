 ...
 */
export const ProgressBar = function(dialog, confirm, opt_options = {}) {
  this.dialog = dialog;
 ...
 * @return {undefined}
 */
ProgressBar.prototype._setOptions = function(opt_options = {}) {
  const _self = this;
 ...
 * @return {!Object}
 */
ProgressBar.prototype._getProgressBar = function(node) {
 ...
 * @return {undefined}
 */
ProgressBar.prototype._separateProgressBars = function(containerCallback, headerCallback, dialogCallback, confirmCallback) {
 ...
 * @return {undefined}
 */
ProgressBar.prototype._progress = function() {
 ...
 * @return {undefined}
 */
ProgressBar.prototype.setBuffer = function(value) {
  this._progress();
  this._separateProgressBars((condition) => {
    if (condition) {
 ...
 * @return {undefined}
 */
ProgressBar.prototype.hide = function(opt_force) {
  this.options.counter--;
