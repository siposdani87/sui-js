import { generateId, mdl, format, md5 } from "../base";
 ...
 * @return {undefined}
 */
Helper.prototype._init = function() {
 ...
 * @return {!Item}
 */
Helper.prototype.createLink = function(name, opt_callback, opt_href = 'javascript:void(0)', opt_description = '', opt_allowAccess = true, opt_cssClasses = ['link']) {
 ...
 * @return {undefined}
 */
Helper.prototype.multipleLink = function(selector, dom, opt_callback, opt_cssClasses = []) {
 ...
 * @return {!Item}
 */
Helper.prototype.link = function(selector, dom, opt_callback, opt_href = '', opt_description = '', opt_allowAccess = true, opt_cssClasses = []) {
 ...
 * @return {undefined}
 */
Helper.prototype.linkElement = function(linkNode, opt_callback, opt_href = '', opt_description = '', opt_allowAccess = true, opt_cssClasses = []) {
  if (!linkNode.isEmpty()) {
    if (opt_allowAccess) {
 ...
 * @return {!Item}
 */
Helper.prototype.createButton = function(name, callback, opt_description = '', opt_allowAccess = true, opt_cssClasses = ['mdl-button--primary']) {
 ...
 * @return {undefined}
 */
Helper.prototype.multipleButton = function(selector, dom, opt_callback, opt_cssClasses = ['mdl-button--primary']) {
 ...
 * @return {!Item}
 */
Helper.prototype.button = function(selector, dom, callback, opt_description = '', opt_allowAccess = true, opt_cssClasses = ['mdl-button--primary']) {
 ...
 * @return {undefined}
 */
Helper.prototype.buttonElement = function(buttonNode, opt_callback, opt_description = '', opt_allowAccess = true, opt_cssClasses = ['mdl-button--primary']) {
 ...
 * @return {!Item}
 */
Helper.prototype.createIconButton = function(iconName, callback, opt_description = '', opt_allowAccess = true, opt_cssClasses = ['mdl-button--accent', 'mdl-button--fab', 'mdl-button--mini-fab']) {
  const buttonNode = new Item('button');
 ...
 * @return {undefined}
 */
Helper.prototype.multipleIconButton = function(selector, dom, opt_cssClasses = ['mdl-button--accent', 'mdl-button--fab', 'mdl-button--mini-fab']) {
  const buttonNodes = new Query(selector, dom);
  buttonNodes.each((buttonNode) => {
 ...
 * @return {!Item}
 */
Helper.prototype.iconButton = function(selector, dom, callback, opt_description = '', opt_allowAccess = true, opt_cssClasses = ['mdl-button--accent', 'mdl-button--fab', 'mdl-button--mini-fab']) {
  const buttonNode = new Query(selector, dom).getItem();
  this.iconButtonElement(buttonNode, callback, opt_description, opt_allowAccess, opt_cssClasses);
  return buttonNode;
};
 ...
 * @return {undefined}
 */
Helper.prototype.iconButtonElement = function(buttonNode, opt_callback, opt_description = '', opt_allowAccess = true, opt_cssClasses = ['mdl-button--accent', 'mdl-button--fab', 'mdl-button--mini-fab']) {
  if (!buttonNode.isEmpty()) {
    if (opt_allowAccess) {
      if (!buttonNode.getId()) {
        buttonNode.setId(generateId('button'));
 ...
 * @return {undefined}
 */
Helper.prototype._createIconNode = function(iconName, parentNode) {
 ...
 * @return {undefined}
 */
Helper.prototype._setTooltip = function(node, opt_description = '') {
  if (opt_description) {
 ...
 * @return {undefined}
 */
Helper.prototype.setGravatar = function(imageNode, defaultImageUrl, email, opt_size = 500, opt_rating = 'g') {
