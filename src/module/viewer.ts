 ...
 */
export const Viewer = function(opt_options = {}) {
  this._setOptions(opt_options);
  this._init();
  this._initBase();
};
Viewer.prototype = Object.create(BaseModal.prototype);
 ...
 * @return {undefined}
 */
Viewer.prototype._setOptions = function(opt_options = {}) {
  const _self = this;
 ...
 * @return {undefined}
 */
Viewer.prototype.loadImage = function(imageUrl, opt_title = '') {
  this._reset();
 ...
 * @return {undefined}
 */
Viewer.prototype._setImage = function(imageUrl) {
