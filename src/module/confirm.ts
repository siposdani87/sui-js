 ...
 */
export const Confirm = function(opt_options = {}) {
  this._setOptions(opt_options);
  this._init();
  this._initBase();
};
Confirm.prototype = Object.create(BaseModal.prototype);
 ...
 * @return {undefined}
 */
Confirm.prototype._setOptions = function(opt_options = {}) {
  const _self = this;
 ...
 */
Confirm.prototype.load = function(message, okText, opt_cancelText = '', opt_title = '', opt_type = 'normal') {
  this._reset();
