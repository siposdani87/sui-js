 ...
 * @extends {BaseTest}
 */
export const TestObjekt = function() {
  BaseTest.call(this, 'Objekt');
};
TestObjekt.prototype = Object.create(BaseTest.prototype);
TestObjekt.prototype.constructor = TestObjekt;

/**
 * @override
 */
TestObjekt.prototype.init = function() {
  this.testMerge();
...
TestObjekt.prototype.testMerge = function() {
...
TestObjekt.prototype.testGetTypedValue = function() {
  const options = new Objekt({
    attr: 'null',
    obj: {
      attr2: '1',
...
TestObjekt.prototype.testGet = function() {
  const options = new Objekt({
    'attr': null,
    'obj': {
      'attr2': 1,
...
TestObjekt.prototype.testSet = function() {
  const options = new Objekt({
    attr: 0,
    obj: {
      attr2: 0,
...
TestObjekt.prototype.testRemove = function() {
  const options = new Objekt({
    attr: 0,
    obj: {
      attr2: 0,
...
TestObjekt.prototype.testCopy = function() {
  const options = new Objekt({
    attr: 0,
    obj: {
      attr2: 0,
