...
• **new Button**(`input`): [`Button`](Button.md)
...
[field/button.ts:6](https://github.com/siposdani87/sui-js/blob/fa20298/src/field/button.ts#L6)
...
[field/button.ts:31](https://github.com/siposdani87/sui-js/blob/fa20298/src/field/button.ts#L31)
...
[field/button.ts:15](https://github.com/siposdani87/sui-js/blob/fa20298/src/field/button.ts#L15)
