...
Defined in: [module/confirm.ts:49](https://github.com/siposdani87/sui-js/blob/433cda184a013753ef41bb6ba61d0b3944481fa1/src/module/confirm.ts#L49)

Confirmation dialog modal with customizable message, action buttons,
and type-based styling. Extends [BaseModal](BaseModal.md) to provide a simple
...
> **new Confirm**(`opt_options?`): `Confirm`

Defined in: [module/confirm.ts:59](https://github.com/siposdani87/sui-js/blob/433cda184a013753ef41bb6ba61d0b3944481fa1/src/module/confirm.ts#L59)
...
Defined in: [module/confirm.ts:50](https://github.com/siposdani87/sui-js/blob/433cda184a013753ef41bb6ba61d0b3944481fa1/src/module/confirm.ts#L50)
...
Defined in: [module/confirm.ts:117](https://github.com/siposdani87/sui-js/blob/433cda184a013753ef41bb6ba61d0b3944481fa1/src/module/confirm.ts#L117)
...
The HTML message content to display in the dialog
    body.
...
The label text for the OK/confirm button.

##### opt\_cancelText?

The label text for the Cancel button. When
...
The title text for the dialog header. When empty
...
The visual style type for the confirmation window.
