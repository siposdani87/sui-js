...
Defined in: [field/textField.ts:15](https://github.com/siposdani87/sui-js/blob/27883240db7565f37a562e906b93c8d6552ac058/src/field/textField.ts#L15)

## Description

Standard text input field with Material Design Lite styling.
Extends [BaseField](BaseField.md) with keyup and change event handling.
...
> **new TextField**(`input`, `label`, `error`, `inputBlock`): `TextField`

Defined in: [field/textField.ts:23](https://github.com/siposdani87/sui-js/blob/27883240db7565f37a562e906b93c8d6552ac058/src/field/textField.ts#L23)
...
The text input element wrapped in a Knot.
...
Defined in: [field/textField.ts:83](https://github.com/siposdani87/sui-js/blob/27883240db7565f37a562e906b93c8d6552ac058/src/field/textField.ts#L83)

#### Returns

`any`

The input element's current value.
...
Defined in: [field/textField.ts:71](https://github.com/siposdani87/sui-js/blob/27883240db7565f37a562e906b93c8d6552ac058/src/field/textField.ts#L71)
...
Refreshes the text field by updating the invalid state and re-applying MDL upgrades.
...
Defined in: [field/textField.ts:55](https://github.com/siposdani87/sui-js/blob/27883240db7565f37a562e906b93c8d6552ac058/src/field/textField.ts#L55)
...
Renders the text field by applying MDL text field classes to the input block, input, and label.
