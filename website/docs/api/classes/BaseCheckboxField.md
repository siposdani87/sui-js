...
Extends [BaseField](BaseField.md) with checked state handling and hidden input support.
...
The checkbox input element wrapped in a Knot.
...
Creates a new BaseCheckboxField instance.
