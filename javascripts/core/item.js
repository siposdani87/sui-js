 ...
 * @param {!SUI.Item=} opt_parentNode
 */
SUI.Item = function(node, opt_parentNode) {
 ...
 * @return {!Element}
 */
SUI.Item.prototype.getNode = function() {
  return this.node;
};
 ...
 * @return {string}
 */
SUI.Item.prototype.getTagName = function() {
 ...
 * @return {string|null}
 */
SUI.Item.prototype.getId = function() {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.setId = function(id) {
  this.node.id = id;
};
 ...
 * @return {undefined}
 */
SUI.Item.prototype.setFor = function(htmlFor) {
 ...
 * @return {string|null}
 */
SUI.Item.prototype.getFor = function() {
 ...
 * @return {boolean}
 */
SUI.Item.prototype.hasClass = function(cssClass) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype._handleClassList = function(cssClasses, callback) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.addClass = function(cssClasses) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.removeClass = function(cssClasses) {
  this._handleClassList(cssClasses, (cssClass) => {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.toggleClass = function(cssClasses) {
  this._handleClassList(cssClasses, (cssClass) => {
 ...
 * @return {!Array}
 */
SUI.Item.prototype.getClasses = function() {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.setAttribute = function(attribute, opt_value) {
 ...
 * @return {*}
 */
SUI.Item.prototype.getAttribute = function(attribute) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.removeAttribute = function(attribute) {
 ...
 * @return {boolean}
 */
SUI.Item.prototype.hasAttribute = function(attribute) {
 ...
 * @return {!Function}
 */
SUI.Item.prototype.addEventListener = function(eventName, opt_callback) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype._addListenerToStore = function(eventName, listener) {
 ...
 * @return {!Array}
 */
SUI.Item.prototype._getListenerToStore = function(eventName) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.removeEventListener = function(eventName, listener) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.removeEventListeners = function(eventName) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.dispatchEvent = function(event) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.trigger = function(eventName) {
 ...
 * @return {!SUI.Item}
 */
SUI.Item.prototype.createElement = function(tagName) {
  const node = document.createElement(tagName);
  return new SUI.Item(node, this);
};
 ...
 * @return {undefined}
 */
SUI.Item.prototype.appendChild = function(node) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.removeChildren = function() {
 ...
 * @return {boolean}
 */
SUI.Item.prototype.hasChildren = function() {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.removeChild = function(node) {
  if (this.hasChildren()) {
    try {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.remove = function() {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.insert = function(node) {
  this.removeChildren();
 ...
 * @return {boolean}
 */
SUI.Item.prototype.beforeChild = function(node) {
 ...
 * @return {boolean}
 */
SUI.Item.prototype.afterChild = function(node) {
  const parentElement = this._getParentElement();
  if (parentElement) {
 ...
 * @return {boolean}
 */
SUI.Item.prototype.insertBefore = function(node) {
  const parentElement = this._getParentElement();
  if (parentElement) {
 ...
 * @return {boolean}
 */
SUI.Item.prototype.insertAfter = function(node) {
 ...
 * @return {boolean}
 */
SUI.Item.prototype.replaceChild = function(node) {
  const parentElement = this._getParentElement();
  if (parentElement) {
 ...
 * @return {!SUI.Item}
 */
SUI.Item.prototype.getNextSibling = function() {
  const referenceNode = this.node.nextSibling || this.node.nextElementSibling;
  return new SUI.Item(/** @type {!Element} */(referenceNode));
};
 ...
 * @return {undefined}
 */
SUI.Item.prototype.setHtml = function(text) {
 ...
 * @return {string}
 */
SUI.Item.prototype.getHtml = function(opt_isInner = false) {
  if (!this.isEmpty()) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.setText = function(text) {
 ...
 * @return {string}
 */
SUI.Item.prototype.getText = function() {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.setData = function(name, value) {
  if (!this.isEmpty()) {
    let data = value;
 ...
 * @return {*}
 */
SUI.Item.prototype.getData = function(name) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.removeData = function(name) {
  if (!this.isEmpty()) {
 ...
 * @return {?SUI.Item}
 */
SUI.Item.prototype.getParentNode = function() {
  const parentElement = this._getParentElement();
  if (parentElement) {
    return new SUI.Item(parentElement);
  }
  return null;
};
 ...
 * @return {?Element}
 */
SUI.Item.prototype._getParentElement = function() {
 ...
 */
SUI.Item.prototype.getComputedStyle = function() {
 ...
 * @return {!Object}
 */
SUI.Item.prototype.getStyle = function() {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.setStyle = function(properties) {
 ...
 * @return {undefined}
 */
SUI.Item.prototype.removeStyle = function(properties) {
 ...
 * @return {boolean}
 */
SUI.Item.prototype.isEmpty = function() {
  return !this.node;
};
 ...
 * @return {boolean}
 */
SUI.Item.prototype.exists = function() {
 ...
 * @return {string}
 */
SUI.Item.prototype.toString = function(opt_isRoot = true) {
  if (opt_isRoot) {
 ...
 * @return {?SUI.Item}
 */
SUI.Item.prototype.cloneNode = function(opt_deep = false) {
  if (!this.isEmpty()) {
    const cloneNode = this.node.cloneNode(opt_deep);
    return new SUI.Item(cloneNode, this.parentNode);
  }
  return null;
};
 ...
 * @return {undefined}
 */
SUI.Item.prototype.clearNode = function() {
