 ...
 * @constructor
 * @this {SUI.Canvas}
 * @param {!SUI.Item|string=} opt_selector
 */
...
SUI.Canvas.prototype._init = function(opt_selector) {
  this.canvasNode = /** @type {!SUI.Item} */ (opt_selector);
  if (SUI.isString(opt_selector)) {
    ...
    this.canvasNode = new SUI.Item('canvas');
  }
...
/**
 * @param {!SUI.Item} image
 * @param {number=} opt_width
 * @param {number=} opt_height
 */
SUI.Canvas.prototype.drawImage = function(image, opt_width, opt_height) {
  const width = opt_width || SUI.typeCast(image.getAttribute('width'));
  const height = opt_height || SUI.typeCast(image.getAttribute('height'));
  this.context.save();
